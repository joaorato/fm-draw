...
const croatiaMatchReports = [
    ...
    },
    {
        ...
        formations: {
            ...
            away: reportFormation("4-2-1-2-1", [
                [reportPlayer("7", "Keita Baldé", "8,1", "AAE", true)],
    ...
    },
    {
        ...
        formations: {
            home: reportFormation("3-5-2", [
                ...
                [reportPlayer("99", "Vózinha", "7,4", "GR")]
            ]),
            away: reportFormation("4-3-3 DM", [
                [reportPlayer("10", "Livaja", "6,4", "AR")],
    ...
    },
    {
        ...
        formations: {
            home: reportFormation("3-1-3-2-1", [
                ...
                [reportPlayer("26", "Jelenić", "7,2", "CP"), reportPlayer("6", "Fran Álvarez", "9,2", "CP", true), reportPlayer("2", "Racoviţan", "6,7", "CP")],
                [reportPlayer("31", "Malenica", "6,8", "GR")]
            ]),
            away: reportFormation("3-4-2-1", [
    ...
    },
    {
        ...
        formations: {
            ...
            away: reportFormation("3-1-3-2-1", [
                ...
                [reportPlayer("26", "Jelenić", "6,6", "CP"), reportPlayer("6", "Fran Álvarez", "6,5", "CP"), reportPlayer("2", "Racoviţan", "6,4", "CP")],
    ...
    },
    {
        ...
        formations: {
            ...
            away: reportFormation("3-5-2", [
                ...
                [reportPlayer("99", "Vózinha", "6,2", "GR")]
            ])
        },
        events: {
    ...
    },
    {
        ...
        formations: {
            ...
            away: reportFormation("3-1-3-2-1", [
                ...
                [reportPlayer("2", "Racoviţan", "6,6", "CP"), reportPlayer("32", "Kata", "6,7", "CP"), reportPlayer("26", "Jelenić", "6,8", "CP")],
    ...
    },
    {
        ...
        formations: {
            home: reportFormation("4-2-2-2 Wide", [
                ...
                [reportPlayer("24", "Rasulov", "6,2", "GR")]
            ]),
            away: reportFormation("4-2-2-2 Wide", [
                ...
                [reportPlayer("99", "Vózinha", "6,0", "GRC")]
            ])
        },
        events: {
    ...
    },
    {
        ...
        formations: {
            home: reportFormation("4-2-2-2 Wide", [
                [reportPlayer("10", "Rui Pedro", "6,1", "AvR"), reportPlayer("9", "I. Sabra", "6,2", "AAE")],
                ...
                [reportPlayer("99", "Vózinha", "7,1", "GRC")]
            ]),
            away: reportFormation("4-3-3 DM", [
    ...
    },
    {
        ...
        formations: {
            home: reportFormation("3-1-3-2-1", [
                ...
                [reportPlayer("26", "Jelenić", "7,5", "CP"), reportPlayer("33", "Hasić", "6,5", "CP"), reportPlayer("2", "Racoviţan", "7,2", "CP")],
    ...
    },
    {
        ...
        formations: {
            ...
            away: reportFormation("4-2-2-2 Wide", [
                ...
                [reportPlayer("26", "Wolski", "7,0", "EAI", true), reportPlayer("11", "Mitrović", "7,1", "Ex")],
                ...
                [reportPlayer("24", "Rasulov", "5,9", "GR")]
            ])
        },
        events: {
    ...
    },
    {
        ...
        formations: {
            ...
            away: reportFormation("3-1-3-2-1", [
                ...
                [reportPlayer("26", "Jelenić", "6,9", "CP"), reportPlayer("33", "Hasić", "6,6", "CP"), reportPlayer("2", "Racoviţan", "6,4", "CP")],
    ...
    },
    {
        ...
        formations: {
            ...
            away: reportFormation("4-2-3-1", [
                ...
                [reportPlayer("3", "Auer", "7,0", "AI"), reportPlayer("14", "Raçi", "7,4", "CC"), reportPlayer("58", "Skelin", "6,9", "CC"), reportPlayer("38", "Hodak", "6,5", "AI")],
                [reportPlayer("33", "Silić", "7,1", "GR")]
            ])
        },
        events: {
    ...
    },
    {
        ...
        formations: {
            home: reportFormation("3-1-3-2-1", [
                ...
                [reportPlayer("26", "Jelenić", "7,3", "CP"), reportPlayer("33", "Hasić", "6,6", "CP"), reportPlayer("2", "Racoviţan", "7,1", "CP")],
            ...
            away: reportFormation("3-5-2", [
                ...
                [reportPlayer("20", "Kolinger", "6,5", "DC"), reportPlayer("13", "Zebić", "6,4", "CP"), reportPlayer("3", "Diop", "6,7", "CP")],
                [reportPlayer("12", "Posavec", "6,5", "GR")]
            ])
        },
        events: {
    ...
    },
    {
        ...
        formations: {
            home: reportFormation("3-5-2", [
                ...
                [reportPlayer("20", "Kolinger", "6,6", "DC"), reportPlayer("13", "Zebić", "6,7", "CP"), reportPlayer("3", "Diop", "6,6", "CP")],
    ...
    },
    {
        ...
        formations: {
            ...
            away: reportFormation("3-1-3-2-1", [
                ...
                [reportPlayer("25", "Borkeeiet", "7,0", "PI")],
                [reportPlayer("26", "Jelenić", "7,0", "CP"), reportPlayer("33", "Hasić", "7,1", "CP"), reportPlayer("2", "Racoviţan", "7,4", "CP")],
    ...
    },
    {
        ...
        formations: {
            home: reportFormation("3-5-2", [
                ...
                [reportPlayer("20", "Kolinger", "7,0", "DC"), reportPlayer("13", "Zebić", "6,5", "CP"), reportPlayer("3", "Diop", "6,6", "CP")],
                [reportPlayer("12", "Posavec", "7,4", "GR")]
            ]),
            away: reportFormation("4-2-3-1", [
                [reportPlayer("17", "Mamut", "6,4", "AR")],
    ...
    },
    {
        ...
        formations: {
            home: reportFormation("3-1-3-2-1", [
                ...
                [reportPlayer("2", "Racoviţan", "6,9", "CP"), reportPlayer("33", "Hasić", "6,2", "CP"), reportPlayer("26", "Jelenić", "6,2", "CP")],
    ...
    },
    {
        ...
        formations: {
            ...
            away: reportFormation("4-3-2-1", [
                ...
                [reportPlayer("99", "Vózinha", "6,5", "GR")]
            ])
        },
        events: {
    ...
    },
    {
        ...
        formations: {
            ...
            away: reportFormation("3-1-3-2-1", [
                ...
                [reportPlayer("2", "Racoviţan", "7,6", "CP"), reportPlayer("15", "Mersinaj", "7,2", "CP"), reportPlayer("26", "Jelenić", "7,1", "CP")],
    ...
    {
        fixtureKey: "2025-04-11-nk-istra-1961-dinamo-zagreb",
        ...
        formations: {
            home: reportFormation("4-2-3-1", [
                [reportPlayer("12", "Obando", "6,8", "AC", true)],
                [reportPlayer("11", "Goričan", "6,6", "AA"), reportPlayer("21", "Núñez", "6,8", "MO"), reportPlayer("17", "Frederiksen", "6,4", "EAI")],
                [reportPlayer("8", "Maurić", "6,8", "MD"), reportPlayer("15", "Liber", "6,8", "CJR")],
                [reportPlayer("22", "Can Coşkun", "6,6", "AI"), reportPlayer("4", "Johnston", "6,4", "CC"), reportPlayer("3", "Nasraoui", "6,9", "DC"), reportPlayer("97", "Kadušić", "6,5", "AI")],
                [reportPlayer("99", "Wrqbel", "6,5", "GR")]
            ]),
            away: reportFormation("4-3-3 DM", [
                [reportPlayer("9", "Dion Beljo", "7,1", "AvR")],
                [reportPlayer("11", "Hoxha", "6,9", "EAI"), reportPlayer("12", "Dobre", "6,0", "EAI")],
                [reportPlayer("14", "Soldo", "6,7", "MC"), reportPlayer("8", "Zajc", "6,7", "MC")],
                [reportPlayer("27", "Mišić", "6,7", "MD")],
                [reportPlayer("22", "Pérez Vinlöf", "7,0", "AI"), reportPlayer("26", "McKenna", "6,7", "CC"), reportPlayer("36", "Domínguez", "6,3", "CC"), reportPlayer("25", "Valinčić", "6,7", "AI")],
                [reportPlayer("40", "Livaković", "6,6", "GR")]
            ])
        },
        events: {
            home: [goalEvent("20", "A. Obando", { assist: "C. Núñez" })],
            away: [sendOffEvent("46", "A. Dobre"), goalEvent("62", "L. Stojković", { assist: "Dion Beljo" }), goalEvent("83", "F. Topić", { assist: "L. Stojković" })]
        },
        stats: reportStats([
            ["Posse", "57%", "43%"],
            ["Remates", "9", "12"],
    ...
    {
        fixtureKey: "2025-04-11-nk-osijek-hnk-gorica",
        date: "Sábado 11 de Abril de 2026",
        stadium: "Opus Arena",
        weather: "Brisa",
        playerOfMatch: "Arnel Jakupović",
        ...
        formations: {
            home: reportFormation("3-1-3-2-1", [
                [reportPlayer("34", "Matković", "9,5", "AR", true)],
                [reportPlayer("23", "Vrbančić", "9,5", "MO", true), reportPlayer("17", "Jakupović", "9,8", "SA", true)],
                [reportPlayer("38", "Čolina", "7,0", "MAI"), reportPlayer("6", "Fran Álvarez", "7,0", "MC"), reportPlayer("39", "Bukvić", "7,9", "MAI")],
                [reportPlayer("25", "Børkeeiet", "7,2", "Pi")],
                [reportPlayer("2", "Racoviţan", "7,3", "CP"), reportPlayer("15", "Mersinaj", "7,2", "CP"), reportPlayer("26", "Jelenić", "7,1", "CP")],
                [reportPlayer("12", "D. Sousa", "7,7", "GR")]
            ]),
            away: reportFormation("4-3-3 DM", [
                [reportPlayer("20", "Vrzić", "6,0", "Ex"), reportPlayer("10", "Pršir", "6,1", "ME"), reportPlayer("9", "Bogojević", "6,0", "Ex")],
                [reportPlayer("8", "Pozo", "6,4", "CJA"), reportPlayer("7", "Bakić", "6,3", "MC")],
                [reportPlayer("36", "Kavelj", "6,6", "MD")],
                [reportPlayer("19", "Čabraja", "6,0", "AI"), reportPlayer("45", "Perić", "6,5", "DC"), reportPlayer("5", "Leš", "6,4", "CP"), reportPlayer("32", "Duraković", "6,0", "AI")],
                [reportPlayer("71", "Matijaš", "6,1", "GRC")]
            ])
        },
        events: {
            home: [goalEvent("23", "A. Jakupović", { assist: "L. Vrbančić" }), goalEvent("28", "L. Vrbančić", { assist: "D. Bukvić" }), goalEvent("56", "A. Jakupović", { assist: "A. Matković" }), goalEvent("58", "A. Matković", { assist: "L. Vrbančić" }), goalEvent("77", "A. Jakupović", { assist: "A. Matković" })],
            away: []
        },
        stats: reportStats([
            ["Posse", "69%", "31%"],
            ["Remates", "20", "11"],
            ["Remates à Baliza", "11", "6"],
            ["xG", "2,96", "0,70"],
            ["PADPAD", "22,50", "34,39"],
            ["Oportunidades Flagrantes", "4", "0"],
            ["Cantos", "8", "8"],
            ["Passes Completados", "92%", "88%"],
            ["Cruzamentos Completados", "39%", "11%"],
            ["Faltas", "5", "11"],
            ["Cartões amarelos", "0", "0"],
            ["Cartões vermelhos", "0", "0"],
            ["Distância Percorrida", "121", "125"],
            ["Classificação Média", "7,8", "6,2"]
        ])
    },
    {
        fixtureKey: "2025-04-11-nk-slaven-belupo-hnk-vukovar",
        date: "Sábado 11 de Abril de 2026",
        stadium: "Gradski stadion Ivan Kušek Apaš",
        weather: "Calmo",
        playerOfMatch: "Filip Krušelj",
        ...
        formations: {
            home: reportFormation("4-4-2", [
                [reportPlayer("90", "Nestorovski", "7,2", "AC", true), reportPlayer("11", "Mitrović", "6,6", "AC")],
                [reportPlayer("28", "Šunta", "7,0", "MA"), reportPlayer("10", "Caimacov", "7,2", "MC", true), reportPlayer("21", "Crepulja", "7,3", "MC"), reportPlayer("8", "Mrowca", "7,5", "MA")],
                [reportPlayer("14", "Jović", "7,0", "DL"), reportPlayer("5", "Katalinić", "7,3", "DC"), reportPlayer("2", "Međimorec", "7,6", "DC"), reportPlayer("18", "Krušelj", "8,0", "DL")],
                [reportPlayer("24", "Rasulov", "7,7", "GR")]
            ]),
            away: reportFormation("4-3-3 DM", [
                [reportPlayer("8", "Horvat", "6,0", "AA"), reportPlayer("21", "Puljić", "6,4", "CL"), reportPlayer("77", "Shabani", "6,7", "Ex")],
                [reportPlayer("41", "Šporn", "6,7", "MC"), reportPlayer("10", "Gonzalez", "6,4", "CJA")],
                [reportPlayer("43", "Čuić", "6,7", "MD")],
                [reportPlayer("3", "Bosec", "6,7", "DL"), reportPlayer("4", "Mitrović", "6,9", "DC"), reportPlayer("5", "Elez", "6,5", "DC"), reportPlayer("2", "Bradley", "6,7", "DL")],
                [reportPlayer("42", "Đaković", "6,1", "GR")]
            ])
        },
        events: {
            home: [goalEvent("8", "I. Nestorovski", { assist: "F. Krušelj" }), goalEvent("26", "M. Caimacov", { assist: "V. Međimorec" })],
            away: []
        },
        stats: reportStats([
            ["Posse", "57%", "43%"],
            ...
            ["Cantos", "4", "7"],
            ["Passes Completados", "90%", "89%"],
            ["Cruzamentos Completados", "33%", "12%"],
            ["Faltas", "5", "6"],
            ["Cartões amarelos", "0", "0"],
            ["Cartões vermelhos", "0", "0"],
            ["Distância Percorrida", "127", "130"],
            ["Classificação Média", "7,2", "6,5"]
        ])
    },
    {
        fixtureKey: "2025-04-11-nk-varazdin-hajduk-split",
        date: "Sábado 11 de Abril de 2026",
        stadium: "Anđelko Herjavec",
        weather: "Calmo",
        playerOfMatch: "Michele Šego",
        rating: "8,39",
        coaches: { home: "João Nabais", away: "S. Bilić" },
        formations: {
            home: reportFormation("4-2-3-1", [
                [reportPlayer("17", "Mamut", "6,5", "AR")],
                [reportPlayer("22", "Mamić", "7,5", "AI", true), reportPlayer("27", "Latković", "6,1", "SA"), reportPlayer("18", "Gaprindashvili", "7,5", "Ex")],
                [reportPlayer("24", "Marina", "6,8", "CJR"), reportPlayer("8", "Duvnjak", "6,3", "CJA")],
                [reportPlayer("15", "Jacob", "6,9", "AI"), reportPlayer("44", "Barać", "6,7", "DC"), reportPlayer("16", "Tepšić", "6,1", "CC"), reportPlayer("4", "Škaričić", "6,5", "DL")],
                [reportPlayer("33", "Silić", "6,6", "GR")]
            ]),
            away: reportFormation("4-2-3-1", [
                [reportPlayer("11", "Šego", "8,4", "AAE", true)],
                [reportPlayer("9", "A. Rebić", "7,9", "CJA"), reportPlayer("10", "Livaja", "6,1", "MO"), reportPlayer("30", "Almena", "7,4", "AI")],
                [reportPlayer("23", "Krovinović", "6,6", "CJR"), reportPlayer("6", "Hugo G.", "6,9", "MD")],
                [reportPlayer("32", "Hrgović", "7,4", "AI"), reportPlayer("14", "Raçi", "6,9", "CC"), reportPlayer("15", "Marešić", "6,5", "CC"), reportPlayer("38", "Hodak", "6,6", "DL")],
                [reportPlayer("33", "Silić", "6,6", "GR")]
            ])
        },
        events: {
            home: [goalEvent("3", "L. Mamić", { assist: "T. Gaprindashvili" })],
            away: [goalEvent("45", "M. Šego", { assist: "I. Almena" }), goalEvent("76", "M. Šego", { assist: "A. Rebić" })]
        },
        stats: reportStats([
            ["Posse", "47%", "53%"],
            ["Remates", "13", "14"],
    ...
    {
        fixtureKey: "2025-04-13-nk-lokomotiva-hnk-rijeka",
        ...
        coaches: { home: "Pai Natal", away: "Zép Jóbes" },
        formations: {
            home: reportFormation("4-3-2-1", [
                [reportPlayer("10", "Rui Pedro", "6,2", "AC")],
                [reportPlayer("80", "Redmond", "6,2", "AA"), reportPlayer("18", "Šitum", "6,2", "AA")],
                [reportPlayer("26", "Rog", "6,1", "ME"), reportPlayer("28", "Belcar", "6,2", "MC"), reportPlayer("21", "Wintle", "6,2", "ME")],
                [reportPlayer("17", "Pajač", "6,6", "DL"), reportPlayer("20", "Kolinger", "6,1", "DC"), reportPlayer("13", "Zebić", "7,1", "CC"), reportPlayer("23", "Vešović", "6,8", "DL")],
                [reportPlayer("12", "Posavec", "6,2", "GR")]
            ]),
            away: reportFormation("4-2-1-2-1", [
                [reportPlayer("7", "Keita Baldé", "6,5", "AAE")],
                [reportPlayer("20", "Ndockyt", "7,2", "ME", true), reportPlayer("10", "Fruk", "8,4", "MO", true)],
                [reportPlayer("17", "Ntcham", "7,0", "MC")],
                [reportPlayer("21", "Lacoux", "6,8", "MD"), reportPlayer("26", "Dantas", "6,8", "CJR")],
                [reportPlayer("34", "Devetak", "8,5", "AI"), reportPlayer("53", "Emirhan", "7,3", "CC"), reportPlayer("6", "Radeljić", "7,3", "CC"), reportPlayer("22", "Oreč", "8,0", "AI")],
                [reportPlayer("1", "Letica", "7,9", "GRP")]
            ])
        },
        events: {
            home: [],
            away: [goalEvent("27", "T. Fruk", { assist: "M. Devetak" }), goalEvent("30", "M. Ndockyt", { assist: "T. Fruk" })]
        },
        stats: reportStats([
            ["Posse", "51%", "49%"],
            ["Remates", "8", "16"],
            ...
            ["Cantos", "7", "7"],
            ["Passes Completados", "87%", "90%"],
            ["Cruzamentos Completados", "0%", "16%"],
            ["Faltas", "13", "6"],
            ["Cartões amarelos", "3", "1"],
            ["Cartões vermelhos", "0", "0"],
            ["Distância Percorrida", "125", "126"],
            ["Classificação Média", "6,4", "7,4"]
        ])
    },
    {
        fixtureKey: "2025-04-18-hajduk-split-hnk-gorica",
        date: "Sábado 18 de Abril de 2026",
        stadium: "Poljud",
        weather: "Calmo",
        playerOfMatch: "Iker Almena",
        rating: "7,89",
        coaches: { home: "S. Bilić", away: "Miguel Cardoso" },
        formations: {
            home: reportFormation("4-2-3-1", [
                [reportPlayer("34", "Durdov", "7,1", "AAE")],
                [reportPlayer("11", "Šego", "6,5", "Ex"), reportPlayer("21", "Pukstas", "7,1", "SA"), reportPlayer("30", "Almena", "7,9", "AI", true)],
                [reportPlayer("7", "Kalik", "7,8", "MAA", true), reportPlayer("15", "Marešić", "7,4", "MD")],
                [reportPlayer("3", "Auer", "7,6", "AlI"), reportPlayer("14", "Raçi", "7,1", "CC"), reportPlayer("58", "Skelin", "6,8", "CC"), reportPlayer("38", "Hodak", "7,5", "DL")],
                [reportPlayer("33", "Silić", "7,3", "GR")]
            ]),
            away: reportFormation("4-3-3 DM", [
                [reportPlayer("20", "Vrzić", "6,0", "Ex"), reportPlayer("10", "Pršir", "6,2", "ME"), reportPlayer("9", "Bogojević", "6,5", "Ex")],
                [reportPlayer("8", "Pozo", "6,2", "CJA"), reportPlayer("7", "Bakić", "6,3", "MC")],
                [reportPlayer("36", "Kavelj", "6,7", "MD")],
                [reportPlayer("19", "Čabraja", "6,5", "AI"), reportPlayer("5", "Leš", "7,2", "DC"), reportPlayer("4", "J. Filipović", "6,6", "CP"), reportPlayer("22", "Trontelj", "6,1", "AI")],
                [reportPlayer("71", "Matijaš", "6,1", "GRC")]
            ])
        },
        events: {
            home: [goalEvent("40", "I. Almena", { assist: "B. Durdov" }), goalEvent("42", "A. Kalik", { assist: "R. Pukstas" })],
            away: []
        },
        stats: reportStats([
            ["Posse", "63%", "37%"],
            ...
            ["Cartões amarelos", "0", "0"],
            ["Cartões vermelhos", "0", "0"],
            ["Distância Percorrida", "125", "130"],
            ["Classificação Média", "7,2", "6,4"]
        ])
    },
    {
        fixtureKey: "2025-04-18-nk-lokomotiva-nk-istra-1961",
        date: "Sábado 18 de Abril de 2026",
        stadium: "Maksimir",
        weather: "Brisa",
        playerOfMatch: "Chema Núñez",
        ...
        formations: {
            home: reportFormation("4-5-1", [
                [reportPlayer("10", "Rui Pedro", "6,5", "AC")],
                [reportPlayer("80", "Redmond", "6,3", "AA"), reportPlayer("18", "Šitum", "6,5", "AA")],
                [reportPlayer("26", "Rog", "6,4", "ME"), reportPlayer("28", "Belcar", "6,5", "MC"), reportPlayer("8", "Antolić", "6,0", "ME")],
                [reportPlayer("17", "Pajač", "6,5", "DL"), reportPlayer("20", "Kolinger", "6,6", "DC"), reportPlayer("13", "Zebić", "6,9", "CC"), reportPlayer("23", "Vešović", "6,5", "DL")],
                [reportPlayer("12", "Posavec", "6,7", "GR")]
            ]),
            away: reportFormation("4-2-3-1", [
                [reportPlayer("12", "Obando", "6,4", "AC")],
                [reportPlayer("11", "Goričan", "7,1", "AA"), reportPlayer("21", "Núñez", "8,5", "MO", true), reportPlayer("17", "Frederiksen", "6,4", "EAI")],
                [reportPlayer("8", "Maurić", "7,1", "MD"), reportPlayer("15", "Liber", "7,3", "CJR", true)],
                [reportPlayer("22", "Can Coşkun", "6,9", "AI"), reportPlayer("4", "Johnston", "7,8", "CC"), reportPlayer("3", "Nasraoui", "7,6", "DC"), reportPlayer("97", "Kadušić", "8,0", "AI")],
                [reportPlayer("99", "Wrąbel", "7,5", "GRC")]
            ])
        },
        events: {
            home: [sendOffEvent("29", "M. Vešović")],
            away: [goalEvent("3", "A. Liber", { assist: "A. Kadušić" }), goalEvent("69", "C. Núñez", { assist: "Benny" }), goalEvent("87", "S. Lončar", { assist: "R. Hrvatin" })]
        },
        stats: reportStats([
            ["Posse", "47%", "53%"],
            ["Remates", "6", "21"],
            ["Remates à Baliza", "0", "10"],
            ["xG", "0,55", "2,66"],
            ["PADPAD", "26,64", "23,11"],
            ["Oportunidades Flagrantes", "0", "2"],
            ["Cantos", "4", "9"],
            ["Passes Completados", "88%", "89%"],
            ["Cruzamentos Completados", "11%", "40%"],
            ["Faltas", "17", "4"],
            ["Cartões amarelos", "3", "0"],
            ["Cartões vermelhos", "1", "0"],
            ["Distância Percorrida", "115", "128"],
            ["Classificação Média", "6,4", "7,4"]
        ])
    },
    {
        fixtureKey: "2025-04-18-nk-osijek-dinamo-zagreb",
        date: "Sábado 18 de Abril de 2026",
        stadium: "Opus Arena",
        weather: "Calmo",
        playerOfMatch: "Mateo Lisica",
        ...
        formations: {
            home: reportFormation("3-1-3-2-1", [
                [reportPlayer("34", "Matković", "7,7", "AR", true)],
                [reportPlayer("23", "Vrbančić", "6,4", "MO"), reportPlayer("17", "Jakupović", "6,7", "SA")],
                [reportPlayer("38", "Čolina", "6,8", "MAI"), reportPlayer("6", "Álvarez", "6,8", "MC"), reportPlayer("39", "Bukvić", "6,4", "MAI")],
                [reportPlayer("25", "Børkeeiet", "6,9", "Pi")],
                [reportPlayer("2", "Racoviţan", "6,9", "CP"), reportPlayer("15", "Mersinaj", "6,6", "CP"), reportPlayer("26", "Jelenić", "7,1", "CP")],
                [reportPlayer("12", "Diogo Sousa", "7,3", "GR")]
            ]),
            away: reportFormation("4-3-3 DM", [
                [reportPlayer("30", "Topić", "6,9", "AAE", true)],
                [reportPlayer("11", "Hoxha", "6,5", "EAI"), reportPlayer("21", "Lisica", "7,8", "EAI")],
                [reportPlayer("14", "Soldo", "6,3", "ME"), reportPlayer("7", "Stojković", "6,1", "ME")],
                [reportPlayer("37", "Radoš", "6,4", "CJR")],
                [reportPlayer("22", "Pérez Vinlöf", "5,8", "AI"), reportPlayer("16", "Torrente", "6,9", "CP"), reportPlayer("15", "Galešić", "6,2", "CC"), reportPlayer("36", "Domínguez", "6,3", "DL")],
                [reportPlayer("40", "Livaković", "6,7", "GR")]
            ])
        },
        events: {
            home: [sendOffEvent("52", "J. Mersinaj"), goalEvent("69", "A. Matković", { assist: "J. Abrigo" })],
            away: [goalEvent("16", "F. Topić", { assist: "M. Lisica" }), sendOffEvent("84", "M. Pérez Vinlöf")]
        },
        stats: reportStats([
            ["Posse", "70%", "30%"],
            ["Remates", "18", "11"],
    ...
    {
        fixtureKey: "2025-04-18-nk-varazdin-hnk-vukovar",
        date: "Sábado 18 de Abril de 2026",
        stadium: "Anđelko Herjavec",
        weather: "Calmo",
        playerOfMatch: "Robin Gonzalez",
        ...
        formations: {
            home: reportFormation("4-2-3-1", [
                [reportPlayer("17", "Mamut", "8,5", "AR", true)],
                [reportPlayer("7", "Vuk", "8,6", "AI"), reportPlayer("22", "Mamić", "6,5", "SA"), reportPlayer("11", "Brajković", "6,9", "Ex", true)],
                [reportPlayer("24", "Marina", "6,8", "CJR"), reportPlayer("6", "Puclin", "6,4", "CJA")],
                [reportPlayer("12", "Bočkaj", "6,5", "AI"), reportPlayer("13", "Mladenovski", "6,8", "DC"), reportPlayer("16", "Tepšić", "7,3", "CC"), reportPlayer("23", "Maglica", "7,3", "DL")],
                [reportPlayer("33", "Silić", "6,8", "GR")]
            ]),
            away: reportFormation("4-3-3 DM", [
                [reportPlayer("9", "Kulušić", "6,3", "AvR")],
                [reportPlayer("8", "Horvat", "6,4", "AI"), reportPlayer("10", "Gonzalez", "8,7", "AI", true)],
                [reportPlayer("77", "Shabani", "6,5", "MC"), reportPlayer("43", "Čuić", "8,1", "CJA", true)],
                [reportPlayer("19", "Mioč", "6,4", "MD")],
                [reportPlayer("3", "Bosec", "6,7", "DL"), reportPlayer("5", "Elez", "6,4", "DC"), reportPlayer("4", "Mitrović", "6,2", "DC"), reportPlayer("91", "Tićinović", "6,4", "DL")],
                [reportPlayer("42", "Đaković", "5,9", "GR")]
            ])
        },
        events: {
            home: [goalEvent("34", "I. Mamut", { penalty: true }), goalEvent("36", "I. Mamut", { assist: "M. Vuk" }), goalEvent("68", "R. Brajković", { assist: "M. Vuk" }), goalEvent("79", "A. Latković", { assist: "I. Mamut" }), goalEvent("85", "A. Latković", { assist: "N. Tepšić" })],
            away: [goalEvent("2", "R. Gonzalez", { assist: "M. Čuić" }), goalEvent("67", "M. Čuić", { assist: "R. Gonzalez" }), goalEvent("89", "Š. Butić", { assist: "M. Čuić" })]
        },
        stats: reportStats([
            ["Posse", "50%", "50%"],
            ["Remates", "16", "15"],
            ["Remates à Baliza", "7", "9"],
            ["xG", "2,58", "1,63"],
            ["PADPAD", "16,52", "17,10"],
            ["Oportunidades Flagrantes", "2", "2"],
            ["Cantos", "2", "9"],
            ["Passes Completados", "90%", "86%"],
            ["Cruzamentos Completados", "31%", "16%"],
            ["Faltas", "7", "11"],
            ["Cartões amarelos", "0", "1"],
            ["Cartões vermelhos", "0", "0"],
            ["Distância Percorrida", "122", "121"],
            ["Classificação Média", "7,2", "6,8"]
        ])
    },
    {
        fixtureKey: "2025-04-19-nk-slaven-belupo-hnk-rijeka",
        date: "Domingo 19 de Abril de 2026",
        stadium: "Gradski stadion Ivan Kušek Apaš",
        weather: "Calmo",
        playerOfMatch: "Jonathan Silva",
        rating: "8,78",
        ...
        formations: {
            home: reportFormation("4-2-2-2 Wide", [
                [reportPlayer("7", "Dabro", "6,9", "AA"), reportPlayer("90", "Nestorovski", "6,8", "AvR", true)],
                [reportPlayer("28", "Šunta", "6,7", "EAI"), reportPlayer("11", "Mitrović", "6,2", "Ex")],
                [reportPlayer("8", "Mrowca", "6,3", "MD"), reportPlayer("21", "Crepulja", "6,3", "CJR")],
                [reportPlayer("3", "Jakir", "6,2", "AI"), reportPlayer("6", "Božić", "6,3", "DC"), reportPlayer("4", "Kovačić", "6,9", "DC"), reportPlayer("18", "Krušelj", "6,3", "DL")],
                [reportPlayer("31", "Hadžikić", "6,8", "GR")]
            ]),
            away: reportFormation("4-2-1-2-1", [
                [reportPlayer("7", "Keita Baldé", "8,3", "AAE", true)],
                [reportPlayer("20", "Ndockyt", "8,0", "ME", true), reportPlayer("10", "Fruk", "6,4", "MO")],
                [reportPlayer("17", "Ntcham", "6,6", "MC")],
                [reportPlayer("21", "Lacoux", "6,5", "MD"), reportPlayer("26", "Tiago Dantas", "6,5", "CJR")],
                [reportPlayer("24", "J. Silva", "8,8", "AI"), reportPlayer("53", "Emirhan", "6,6", "CC"), reportPlayer("6", "Radeljić", "6,8", "CC"), reportPlayer("22", "Oreč", "6,9", "AI")],
                [reportPlayer("1", "Letica", "6,6", "GRP")]
            ])
        },
        events: {
            home: [goalEvent("3", "I. Nestorovski", { assist: "M. Dabro" })],
            away: [goalEvent("21", "M. Ndockyt", { assist: "K. Baldé" }), goalEvent("83", "T. Božić", { ownGoal: true }), goalEvent("90+3", "K. Baldé", { assist: "J. Silva" })]
        },
        stats: reportStats([
            ["Posse", "42%", "58%"],
            ["Remates", "5", "18"],
            ...
            ["Oportunidades Flagrantes", "1", "3"],
            ["Cantos", "3", "9"],
            ["Passes Completados", "83%", "90%"],
            ["Cruzamentos Completados", "6%", "25%"],
            ["Faltas", "18", "9"],
            ["Cartões amarelos", "1", "2"],
            ["Cartões vermelhos", "0", "0"],
            ["Distância Percorrida", "119", "122"],
    ...
    {
        fixtureKey: "2025-04-22-dinamo-zagreb-nk-varazdin",
        ...
        formations: {
            home: reportFormation("4-3-3 DM", [
                ...
                [reportPlayer("11", "Hoxha", "6,0", "EAI"), reportPlayer("12", "Dobre", "7,2", "EAI")],
                [reportPlayer("14", "Soldo", "6,7", "ME"), reportPlayer("8", "Zajc", "6,8", "MC")],
                [reportPlayer("27", "Mišić", "6,5", "MD")],
                [reportPlayer("3", "Goda", "6,5", "DL"), reportPlayer("26", "McKenna", "6,3", "CC"), reportPlayer("36", "Domínguez", "6,7", "CC"), reportPlayer("25", "Valinčić", "6,4", "AI")],
                [reportPlayer("40", "Livaković", "6,4", "GR")]
            ]),
            away: reportFormation("4-2-3-1", [
                [reportPlayer("17", "Mamut", "7,3", "AR", true)],
                [reportPlayer("7", "Vuk", "9,6", "AI", true), reportPlayer("27", "Latković", "9,1", "SA", true), reportPlayer("18", "Gaprindashvili", "7,3", "Ex")],
                [reportPlayer("24", "Marina", "6,9", "CJR"), reportPlayer("8", "Duvnjak", "6,6", "CJA")],
                [reportPlayer("12", "Bočkaj", "6,0", "AI"), reportPlayer("44", "Barać", "7,0", "DC"), reportPlayer("16", "Tepšić", "6,9", "CC"), reportPlayer("23", "Maglica", "7,3", "DL")],
                [reportPlayer("34", "Novak", "7,1", "GR")]
            ])
        },
        events: {
            home: [goalEvent("25", "Dion Beljo", { assist: "A. Dobre" })],
            away: [goalEvent("3", "M. Vuk", { assist: "A. Latković" }), goalEvent("15", "A. Latković", { assist: "M. Vuk" }), goalEvent("42", "I. Mamut", { assist: "T. Gaprindashvili" }), goalEvent("48", "M. Vuk", { assist: "A. Latković" })]
        },
        stats: reportStats([
            ["Posse", "53%", "47%"],
            ["Remates", "11", "14"],
            ...
            ["Oportunidades Flagrantes", "0", "0"],
            ["Cantos", "4", "6"],
            ["Passes Completados", "85%", "85%"],
            ["Cruzamentos Completados", "18%", "16%"],
            ["Faltas", "7", "9"],
            ["Cartões amarelos", "1", "1"],
            ["Cartões vermelhos", "0", "0"],
            ["Distância Percorrida", "125", "130"],
    ...
    {
        fixtureKey: "2025-04-22-hnk-gorica-nk-lokomotiva",
        date: "Quarta-feira 22 de Abril de 2026",
        stadium: "Gradski stadion Velika Gorica",
        weather: "Calmo",
        playerOfMatch: "Théo Epailly",
        rating: "8,49",
        coaches: { home: "Miguel Cardoso", away: "Pai Natal" },
        formations: {
            home: reportFormation("4-3-3 DM", [
                [reportPlayer("20", "Vrzić", "7,1", "Ex"), reportPlayer("10", "Pršir", "8,5", "ME", true), reportPlayer("9", "Bogojević", "6,8", "Ex")],
                [reportPlayer("8", "Pozo", "7,7", "CJA"), reportPlayer("7", "Bakić", "6,9", "MC")],
                [reportPlayer("36", "Kavelj", "7,3", "MD", true)],
                [reportPlayer("32", "Duraković", "6,9", "AI"), reportPlayer("4", "J. Filipović", "7,2", "DC"), reportPlayer("5", "Leš", "7,5", "CP"), reportPlayer("22", "Trontelj", "6,8", "AI")],
                [reportPlayer("71", "Matijaš", "6,6", "GRC")]
            ]),
            away: reportFormation("4-5-1", [
                [reportPlayer("10", "Rui Pedro", "6,3", "AC")],
                [reportPlayer("40", "McCarthy", "6,5", "AA"), reportPlayer("20", "Kolinger", "6,4", "AA")],
                [reportPlayer("26", "Rog", "6,4", "ME"), reportPlayer("15", "Stojaković", "6,4", "MC"), reportPlayer("80", "Redmond", "6,9", "ME", true)],
                [reportPlayer("17", "Pajač", "6,5", "DL"), reportPlayer("3", "Diop", "6,7", "DC"), reportPlayer("27", "Heiðarsson", "6,1", "CC"), reportPlayer("18", "Šitum", "6,3", "DL")],
                [reportPlayer("99", "Vózinha", "7,0", "GR")]
            ])
        },
        events: {
            home: [goalEvent("10", "J. Pršir", { assist: "I. Pozo" }), goalEvent("28", "A. Kavelj"), goalEvent("52", "J. Pršir", { assist: "T. Epailly" }), goalEvent("72", "T. Epailly", { assist: "L. Vrzić" })],
            away: [goalEvent("45+4", "N. Redmond", { assist: "M. Pajač" })]
        },
        stats: reportStats([
            ["Posse", "39%", "61%"],
            ["Remates", "32", "10"],
            ["Remates à Baliza", "14", "2"],
            ["xG", "2,61", "0,33"],
            ["PADPAD", "24,10", "38,67"],
            ["Oportunidades Flagrantes", "1", "0"],
            ["Cantos", "9", "2"],
    ...
    },
    {
        ...
        formations: {
            home: reportFormation("4-2-3-1", [
                [reportPlayer("11", "Šego", "7,0", "AAE", true)],
                [reportPlayer("9", "A. Rebić", "6,1", "AI"), reportPlayer("10", "Livaja", "6,9", "MO"), reportPlayer("30", "Almena", "6,5", "AI")],
    ...
    },
    {
        ...
        formations: {
            home: reportFormation("4-3-3 DM", [
                ...
                [reportPlayer("36", "Kavelj", "6,8", "MD")],
                [reportPlayer("32", "Duraković", "6,5", "AI"), reportPlayer("4", "J. Filipović", "6,7", "DC"), reportPlayer("5", "Leš", "6,8", "CP"), reportPlayer("22", "Trontelj", "6,4", "AI")],
                [reportPlayer("71", "Matijaš", "6,4", "GRC")]
            ]),
            away: reportFormation("4-3-3 DM", [
    ...
    },
    {
        ...
        formations: {
            home: reportFormation("4-5-1", [
                ...
                [reportPlayer("21", "Wintle", "6,9", "ME"), reportPlayer("9", "I. Sabra", "6,4", "MC"), reportPlayer("80", "Redmond", "6,2", "ME")],
    ...
    },
    {
        ...
        formations: {
            ...
            away: reportFormation("4-2-1-2-1", [
                [reportPlayer("7", "Keita Baldé", "7,2", "AAE", true)],
                ...
                [reportPlayer("24", "J. Silva", "7,0", "AI"), reportPlayer("53", "Emirhan", "6,7", "CC"), reportPlayer("6", "Radeljić", "7,1", "CC", true), reportPlayer("22", "Oreč", "7,7", "AI", true)],
    ...
    {
        fixtureKey: "2025-05-02-dinamo-zagreb-hnk-gorica",
        date: "Sábado 2 de Maio de 2026",
        stadium: "Maksimir",
        weather: "Calmo",
        playerOfMatch: "Sergi Domínguez",
        rating: "8,20",
        ...
        formations: {
            home: reportFormation("4-3-3 DM", [
                [reportPlayer("9", "Dion Beljo", "6,7", "AvR")],
                [reportPlayer("11", "Hoxha", "6,6", "EAI"), reportPlayer("12", "Dobre", "7,2", "EAI", true)],
                [reportPlayer("14", "Soldo", "7,0", "MC"), reportPlayer("8", "Zajc", "7,8", "MC")],
                [reportPlayer("27", "Mišić", "7,2", "MD")],
                [reportPlayer("22", "Pérez Vinlöf", "7,1", "AI"), reportPlayer("26", "McKenna", "7,1", "CC"), reportPlayer("36", "Domínguez", "8,2", "CC", true), reportPlayer("25", "Valinčić", "6,9", "AI")],
                [reportPlayer("40", "Livaković", "7,3", "GR")]
            ]),
            away: reportFormation("4-3-3", [
                [reportPlayer("64", "Epailly", "6,3", "Ex"), reportPlayer("10", "Pršir", "6,1", "ME"), reportPlayer("20", "Vrzić", "5,9", "Ex")],
                [reportPlayer("24", "Pavičić", "6,2", "CJA"), reportPlayer("7", "Bakić", "6,6", "MC")],
                [reportPlayer("36", "Kavelj", "6,0", "MD")],
                [reportPlayer("32", "Duraković", "6,5", "AI"), reportPlayer("4", "J. Filipović", "6,5", "DC"), reportPlayer("5", "Leš", "6,3", "CP"), reportPlayer("22", "Trontelj", "6,0", "AI")],
                [reportPlayer("71", "Matijaš", "6,6", "GRC")]
            ])
        },
        events: {
            home: [goalEvent("41", "A. Dobre", { assist: "M. Zajc" }), goalEvent("64", "S. Domínguez")],
            away: []
        },
        stats: reportStats([
            ["Posse", "74%", "26%"],
            ...
            ["Oportunidades Flagrantes", "3", "1"],
            ["Cantos", "9", "3"],
            ["Passes Completados", "93%", "85%"],
            ["Cruzamentos Completados", "17%", "19%"],
            ["Faltas", "5", "11"],
            ["Cartões amarelos", "0", "0"],
            ["Cartões vermelhos", "0", "0"],
            ["Distância Percorrida", "115", "116"],
            ["Classificação Média", "7,2", "6,3"]
        ])
    },
    {
        fixtureKey: "2025-05-02-nk-istra-1961-nk-varazdin",
        date: "Sábado 2 de Maio de 2026",
        stadium: "Aldo Drosina",
        weather: "Calmo",
        playerOfMatch: "Tornike Gaprindashvili",
        rating: "7,77",
        coaches: { home: "João Pedro Rato", away: "João Nabais" },
        formations: {
            home: reportFormation("4-2-3-1", [
                [reportPlayer("14", "Tóth", "6,4", "AC")],
                [reportPlayer("7", "Benny", "6,4", "AA"), reportPlayer("21", "Núñez", "6,5", "MO"), reportPlayer("17", "Frederiksen", "6,6", "EAI")],
                [reportPlayer("5", "Radošević", "6,5", "MD"), reportPlayer("15", "Liber", "6,5", "CJR")],
                [reportPlayer("26", "Heister", "6,6", "AI"), reportPlayer("4", "Johnston", "6,7", "CC"), reportPlayer("3", "Nasraoui", "6,4", "DC"), reportPlayer("97", "Kadušić", "6,5", "AI")],
                [reportPlayer("99", "Wrąbel", "6,7", "GRC")]
            ]),
            away: reportFormation("4-2-3-1", [
                [reportPlayer("17", "Mamut", "6,5", "AR")],
                [reportPlayer("7", "Vuk", "7,4", "AI", true), reportPlayer("27", "Latković", "6,8", "SA"), reportPlayer("18", "Gaprindashvili", "7,8", "Ex")],
                [reportPlayer("6", "Puclin", "7,5", "CJR"), reportPlayer("8", "Duvnjak", "6,6", "CJA")],
                [reportPlayer("15", "Jacob", "6,3", "AI"), reportPlayer("44", "Barać", "7,1", "DC"), reportPlayer("16", "Tepšić", "7,1", "CC"), reportPlayer("23", "Maglica", "7,7", "DL")],
                [reportPlayer("34", "Novak", "7,6", "GR")]
            ])
        },
        events: {
            home: [],
            away: [goalEvent("20", "M. Vuk", { assist: "T. Gaprindashvili" }), goalEvent("86", "I. Tavares", { assist: "P. Bočkaj" })]
        },
        stats: reportStats([
            ["Posse", "50%", "50%"],
            ["Remates", "11", "16"],
    ...
    {
        fixtureKey: "2025-05-02-hnk-rijeka-hajduk-split",
        date: "Sábado 2 de Maio de 2026",
        stadium: "Rujevica",
        weather: "Calmo",
        playerOfMatch: "Toni Fruk",
        rating: "9,91",
        coaches: { home: "Zép Jóbes", away: "S. Bilić" },
        formations: {
            home: reportFormation("4-2-1-2-1", [
                [reportPlayer("7", "Keita Baldé", "8,9", "AAE", true)],
                [reportPlayer("20", "Ndockyt", "6,6", "ME"), reportPlayer("10", "Fruk", "9,9", "MO", true)],
                [reportPlayer("14", "Gojak", "7,7", "MC", true)],
                [reportPlayer("21", "Lacoux", "7,3", "MD"), reportPlayer("17", "Ntcham", "8,1", "CJR")],
                [reportPlayer("24", "J. Silva", "8,5", "AI", true), reportPlayer("53", "Emirhan", "7,2", "CC"), reportPlayer("6", "Radeljić", "6,8", "CC"), reportPlayer("22", "Oreč", "8,2", "AI", true)],
                [reportPlayer("1", "Letica", "6,8", "GRP")]
            ]),
            away: reportFormation("4-2-3-1", [
                [reportPlayer("11", "Šego", "6,9", "AAE", true)],
                [reportPlayer("9", "A. Rebić", "6,8", "AI"), reportPlayer("21", "Pukstas", "6,8", "SA", true), reportPlayer("30", "Almena", "6,5", "AI")],
                [reportPlayer("23", "Krovinović", "6,9", "CJR"), reportPlayer("6", "Guillamón", "7,1", "MD", true)],
                [reportPlayer("32", "Hrgović", "6,3", "AI"), reportPlayer("14", "Raçi", "6,5", "CC"), reportPlayer("31", "Šarlija", "6,4", "CP"), reportPlayer("38", "Hodak", "6,7", "DL")],
                [reportPlayer("33", "Silić", "7,4", "GR")]
            ])
        },
        events: {
            home: [goalEvent("5", "T. Fruk", { assist: "T. Lacoux" }), goalEvent("17", "K. Baldé", { assist: "T. Fruk" }), goalEvent("24", "A. Oreč", { assist: "O. Ntcham" }), goalEvent("29", "K. Baldé", { assist: "T. Fruk" }), goalEvent("32", "J. Silva", { assist: "O. Ntcham" }), goalEvent("66", "A. Jurić", { assist: "A. Oreč" }), goalEvent("73", "A. Gojak", { assist: "T. Fruk" }), goalEvent("87", "A. Jurić", { assist: "J. Silva" })],
            away: [goalEvent("16", "H. Guillamón", { assist: "F. Krovinović" }), goalEvent("34", "M. Šego", { assist: "A. Rebić" }), goalEvent("90+3", "R. Pukstas", { assist: "A. Elis" })]
        },
        stats: reportStats([
            ["Posse", "46%", "54%"],
            ["Remates", "21", "12"],
            ["Remates à Baliza", "13", "6"],
            ["xG", "3,86", "0,93"],
            ["PADPAD", "20,04", "18,83"],
            ["Oportunidades Flagrantes", "3", "0"],
            ["Cantos", "8", "3"],
            ["Passes Completados", "89%", "90%"],
            ["Cruzamentos Completados", "32%", "25%"],
            ["Faltas", "6", "10"],
            ["Cartões amarelos", "3", "3"],
            ["Cartões vermelhos", "0", "0"],
            ["Distância Percorrida", "128", "123"],
            ["Classificação Média", "7,9", "6,7"]
        ])
    },
    {
        fixtureKey: "2025-05-02-nk-slaven-belupo-nk-osijek",
        date: "Sábado 2 de Maio de 2026",
        stadium: "Gradski stadion Ivan Kušek Apaš",
        weather: "Brisa",
        playerOfMatch: "Anton Matković",
        ...
        formations: {
            home: reportFormation("4-2-3-1", [
                [reportPlayer("7", "Dabro", "6,2", "AAE")],
                [reportPlayer("11", "Mitrović", "7,2", "Ex"), reportPlayer("26", "Wolski", "6,0", "MO"), reportPlayer("10", "Caimacov", "6,9", "CJA")],
                [reportPlayer("21", "Crepulja", "6,5", "CJR"), reportPlayer("8", "Mrowca", "6,4", "MD")],
                [reportPlayer("5", "Katalinić", "6,8", "LI"), reportPlayer("6", "Božić", "6,7", "DC"), reportPlayer("4", "Kovačić", "6,9", "DC"), reportPlayer("18", "Krušelj", "6,3", "AP")],
                [reportPlayer("31", "Hadžikić", "6,9", "GR")]
            ]),
            away: reportFormation("3-1-3-2-1", [
                [reportPlayer("34", "Matković", "7,9", "AR", true)],
                [reportPlayer("99", "Teklić", "6,4", "CJA"), reportPlayer("17", "Jakupović", "6,7", "SA")],
                [reportPlayer("20", "Gradel", "6,7", "MAI"), reportPlayer("6", "Álvarez", "7,6", "MC"), reportPlayer("39", "Bukvić", "7,9", "MAI")],
                [reportPlayer("32", "Kata", "6,9", "CJR")],
                [reportPlayer("2", "Racoviţan", "6,8", "CP"), reportPlayer("15", "Mersinaj", "7,8", "CP"), reportPlayer("26", "Jelenić", "7,2", "CP")],
                [reportPlayer("12", "Diogo Sousa", "7,3", "GR")]
            ])
        },
        events: {
            home: [],
            away: [goalEvent("43", "A. Matković", { assist: "D. Bukvić" })]
        },
        stats: reportStats([
            ["Posse", "38%", "62%"],
            ["Remates", "8", "17"],
            ...
            ["Oportunidades Flagrantes", "1", "1"],
            ["Cantos", "3", "8"],
            ["Passes Completados", "85%", "90%"],
            ["Cruzamentos Completados", "19%", "20%"],
            ["Faltas", "10", "9"],
            ["Cartões amarelos", "2", "2"],
            ["Cartões vermelhos", "0", "0"],
            ["Distância Percorrida", "139", "143"],
            ["Classificação Média", "6,6", "7,2"]
        ])
    },
    {
        fixtureKey: "2025-05-02-hnk-vukovar-nk-lokomotiva",
        date: "Sábado 2 de Maio de 2026",
        stadium: "Gradski vrt",
        weather: "Calmo",
        playerOfMatch: "Aleksandar Trajkovski",
        ...
        formations: {
            home: reportFormation("4-3-3 DM", [
                ...
                [reportPlayer("8", "Horvat", "6,1", "AI"), reportPlayer("36", "Butić", "7,2", "AI")],
                [reportPlayer("77", "Shabani", "6,5", "MC"), reportPlayer("43", "Čuić", "6,6", "CJA")],
                [reportPlayer("41", "Šporn", "6,2", "MD")],
                [reportPlayer("3", "Bosec", "6,8", "AI"), reportPlayer("24", "Marić", "7,1", "CC"), reportPlayer("12", "Živković", "7,0", "DC"), reportPlayer("91", "Tićinović", "6,2", "AI")],
                [reportPlayer("1", "Bulat", "6,8", "GR")]
            ]),
            away: reportFormation("4-5-1", [
                [reportPlayer("15", "Stojaković", "6,5", "AC")],
                [reportPlayer("40", "McCarthy", "6,5", "AA"), reportPlayer("20", "Kolinger", "6,5", "AA")],
                [reportPlayer("28", "Belcar", "6,9", "ME"), reportPlayer("9", "I. Sabra", "7,8", "MC", true), reportPlayer("80", "Redmond", "7,1", "ME")],
                [reportPlayer("25", "Kamenović", "6,9", "DL"), reportPlayer("3", "Diop", "6,9", "DC"), reportPlayer("26", "Rog", "6,7", "CC"), reportPlayer("19", "Tabinas", "6,4", "DL")],
                [reportPlayer("99", "Vózinha", "6,8", "GR")]
            ])
        },
        events: {
            home: [goalEvent("90+1", "I. Santini", { assist: "J. Moreno" })],
            away: [goalEvent("64", "I. Sabra", { assist: "A. Trajkovski" }), goalEvent("72", "A. Trajkovski", { assist: "N. Redmond" })]
        },
        stats: reportStats([
            ["Posse", "64%", "36%"],
            ["Remates", "17", "12"],
...
,
    {
        ...
        formations: {
            home: reportFormation("4-2-3-1", [
                ...
                [reportPlayer("32", "Hrgović", "6,3", "AI"), reportPlayer("14", "Raçi", "6,3", "CC"), reportPlayer("15", "Marešić", "6,0", "CC"), reportPlayer("38", "Hodak", "6,6", "DL")],
                [reportPlayer("1", "Ivušić", "5,9", "GRC")]
            ]),
            away: reportFormation("4-2-1-2-1", [
                [reportPlayer("7", "Keita Baldé", "6,6", "AAE")],
                ...
                [reportPlayer("24", "J. Silva", "7,8", "AI", true), reportPlayer("53", "Emirhan", "7,4", "CC"), reportPlayer("6", "Radeljić", "7,6", "CC"), reportPlayer("22", "Oreč", "8,0", "AI")],
                [reportPlayer("1", "Letica", "6,7", "GRP")]
            ])
        },
        events: {
            home: [goalEvent("29", "M. Livaja")],
            away: [goalEvent("37", "J. Silva", { assist: "A. Oreč" }), goalEvent("63", "A. Jurić", { assist: "A. Gojak" }), goalEvent("67", "A. Gojak", { assist: "J. Silva" }), goalEvent("82", "T. Ambrose", { assist: "A. Jurić" }), goalEvent("88", "A. Jurić", { assist: "S. Radeljić" })]
        },
        stats: reportStats([
            ["Posse", "42%", "58%"],
            ["Remates", "10", "24"],
    ...
    {
        fixtureKey: "2025-05-09-hajduk-split-nk-istra-1961",
        date: "Sábado 9 de Maio de 2026",
        stadium: "Poljud",
        weather: "Brisa",
        playerOfMatch: "Silvio Goričan",
        rating: "7,62",
        coaches: { home: "S. Bilić", away: "João Pedro Rato" },
        formations: {
            home: reportFormation("4-2-3-1", [
                [reportPlayer("34", "Durdov", "6,9", "AAE", true)],
                [reportPlayer("16", "Bengtsson", "7,3", "AA", true), reportPlayer("4", "Pajaziti", "6,4", "ME"), reportPlayer("30", "Almena", "6,3", "AI")],
                [reportPlayer("7", "Kalik", "7,0", "MAA"), reportPlayer("15", "Marešić", "7,1", "MD")],
                [reportPlayer("3", "Auer", "7,2", "AlI"), reportPlayer("14", "Raçi", "6,9", "CC"), reportPlayer("58", "Skelin", "6,8", "CC"), reportPlayer("38", "Hodak", "6,7", "DL")],
                [reportPlayer("1", "Ivušić", "7,5", "GRC")]
            ]),
            away: reportFormation("4-2-3-1", [
                [reportPlayer("9", "Prevljak", "6,2", "AC")],
                [reportPlayer("11", "Goričan", "7,6", "AA"), reportPlayer("21", "Núñez", "6,4", "MO"), reportPlayer("7", "Benny", "6,4", "EAI")],
                [reportPlayer("8", "Maurić", "6,8", "MD"), reportPlayer("15", "Liber", "6,5", "CJR")],
                [reportPlayer("26", "Heister", "6,6", "AI"), reportPlayer("4", "Johnston", "6,7", "CC"), reportPlayer("3", "Nasraoui", "6,9", "DC"), reportPlayer("2", "Ángel Pérez", "6,9", "AI")],
                [reportPlayer("99", "Wrąbel", "6,3", "GRC")]
            ])
        },
        events: {
            home: [goalEvent("38", "L. Bengtsson", { assist: "A. Kalik" }), goalEvent("65", "B. Durdov")],
            away: []
        },
        stats: reportStats([
            ["Posse", "39%", "61%"],
            ...
            ["Cantos", "4", "7"],
            ["Passes Completados", "87%", "91%"],
            ["Cruzamentos Completados", "14%", "10%"],
            ["Faltas", "10", "9"],
            ["Cartões amarelos", "0", "2"],
            ["Cartões vermelhos", "0", "0"],
            ["Distância Percorrida", "129", "133"],
            ["Classificação Média", "6,9", "6,6"]
        ])
    },
    {
        fixtureKey: "2025-05-09-hnk-gorica-hnk-rijeka",
        date: "Sábado 9 de Maio de 2026",
        stadium: "Gradski stadion Velika Gorica",
        weather: "Calmo",
        playerOfMatch: "Toni Fruk",
        ...
        formations: {
            home: reportFormation("4-3-3 DM", [
                [reportPlayer("20", "Vrzić", "6,3", "Ex"), reportPlayer("10", "Pršir", "6,2", "ME"), reportPlayer("9", "Bogojević", "6,9", "Ex", true)],
                [reportPlayer("18", "Fiolić", "6,4", "CJA"), reportPlayer("7", "Bakić", "6,7", "MC")],
                [reportPlayer("36", "Kavelj", "7,0", "MD")],
                [reportPlayer("32", "Duraković", "6,2", "AI"), reportPlayer("4", "J. Filipović", "6,8", "DC"), reportPlayer("5", "Leš", "7,0", "CP"), reportPlayer("22", "Trontelj", "6,5", "AI")],
                [reportPlayer("71", "Matijaš", "7,9", "GRC")]
            ]),
            away: reportFormation("4-2-1-2-1", [
                [reportPlayer("7", "Keita Baldé", "6,5", "AAE")],
                [reportPlayer("20", "Ndockyt", "7,8", "ME"), reportPlayer("10", "Fruk", "8,3", "MO", true)],
                [reportPlayer("14", "Gojak", "6,6", "MC")],
                [reportPlayer("21", "Lacoux", "6,9", "MD"), reportPlayer("17", "Ntcham", "7,0", "CJR")],
                [reportPlayer("24", "J. Silva", "7,3", "AI"), reportPlayer("53", "Emirhan", "7,0", "CC"), reportPlayer("6", "Radeljić", "6,5", "CC"), reportPlayer("23", "Lasickas", "7,0", "AI")],
                [reportPlayer("1", "Letica", "6,7", "GRP")]
            ])
        },
        events: {
            home: [goalEvent("34", "B. Bogojević", { assist: "A. Kavelj" })],
            away: [goalEvent("45", "T. Fruk", { assist: "M. Ndockyt" })]
        },
        stats: reportStats([
            ["Posse", "38%", "62%"],
            ["Remates", "4", "27"],
            ["Remates à Baliza", "4", "13"],
            ["xG", "0,65", "2,11"],
            ["PADPAD", "23,80", "10,97"],
            ["Oportunidades Flagrantes", "1", "2"],
            ["Cantos", "3", "13"],
            ["Passes Completados", "85%", "92%"],
            ["Cruzamentos Completados", "7%", "27%"],
            ["Faltas", "14", "11"],
            ["Cartões amarelos", "1", "2"],
            ["Cartões vermelhos", "0", "0"],
            ["Distância Percorrida", "117", "123"],
    ...
    {
        fixtureKey: "2025-05-09-nk-lokomotiva-nk-osijek",
        date: "Sábado 9 de Maio de 2026",
        stadium: "Maksimir",
        weather: "Calmo",
        playerOfMatch: "David Čolina",
        rating: "8,87",
        coaches: { home: "Pai Natal", away: "Gamy Chambelito" },
        formations: {
            home: reportFormation("4-3-3 DM", [
                [reportPlayer("9", "I. Sabra", "6,4", "AC")],
                [reportPlayer("80", "Redmond", "7,2", "AA", true), reportPlayer("18", "Šitum", "6,2", "AA")],
                [reportPlayer("21", "Wintle", "7,1", "MC"), reportPlayer("8", "Antolić", "6,0", "ME")],
                [reportPlayer("28", "Belcar", "6,7", "CJR")],
                [reportPlayer("17", "Pajač", "6,7", "DL"), reportPlayer("20", "Kolinger", "7,0", "DC", true), reportPlayer("13", "Zebić", "6,3", "CC"), reportPlayer("23", "Vešović", "6,7", "DL")],
                [reportPlayer("12", "Posavec", "7,6", "GR")]
            ]),
            away: reportFormation("3-1-3-2-1", [
                [reportPlayer("34", "Matković", "7,5", "AR", true)],
                [reportPlayer("23", "Vrbančić", "7,0", "MO"), reportPlayer("17", "Jakupović", "8,4", "SA", true)],
                [reportPlayer("38", "Čolina", "8,9", "MAI"), reportPlayer("6", "Álvarez", "6,7", "MC"), reportPlayer("39", "Bukvić", "8,2", "MAI")],
                [reportPlayer("32", "Kata", "7,2", "CJR")],
                [reportPlayer("2", "Racoviţan", "6,9", "CC"), reportPlayer("15", "Mersinaj", "6,8", "CP"), reportPlayer("26", "Jelenić", "6,9", "CC")],
                [reportPlayer("12", "Diogo Sousa", "6,7", "GR")]
            ])
        },
        events: {
            home: [goalEvent("48", "N. Redmond", { assist: "R. Wintle" }), goalEvent("60", "D. Kolinger", { assist: "M. Pajač" })],
            away: [goalEvent("6", "A. Matković", { assist: "D. Čolina" }), goalEvent("11", "A. Jakupović", { assist: "D. Bukvić" }), goalEvent("23", "A. Jakupović", { assist: "D. Čolina" }), goalEvent("25", "J. Posavec", { ownGoal: true })]
        },
        stats: reportStats([
            ["Posse", "47%", "53%"],
            ["Remates", "9", "24"],
            ["Remates à Baliza", "6", "13"],
            ["xG", "0,74", "4,15"],
            ["PADPAD", "19,44", "13,16"],
            ["Oportunidades Flagrantes", "0", "5"],
            ["Cantos", "4", "15"],
            ["Passes Completados", "85%", "90%"],
            ["Cruzamentos Completados", "18%", "11%"],
            ["Faltas", "12", "6"],
            ["Cartões amarelos", "2", "0"],
            ["Cartões vermelhos", "0", "0"],
    ...
    {
        fixtureKey: "2025-05-09-nk-varazdin-nk-slaven-belupo",
        date: "Sábado 9 de Maio de 2026",
        stadium: "Anđelko Herjavec",
        weather: "Calmo",
        playerOfMatch: "Roko Brajković",
        rating: "7,66",
        coaches: { home: "João Nabais", away: "Francisco Pinto" },
        formations: {
            home: reportFormation("4-2-3-1", [
                [reportPlayer("17", "Mamut", "6,5", "AR")],
                [reportPlayer("38", "Tavares", "7,2", "AI", true), reportPlayer("27", "Latković", "6,6", "SA"), reportPlayer("11", "Brajković", "7,7", "Ex")],
                [reportPlayer("6", "Puclin", "6,5", "CJR"), reportPlayer("8", "Duvnjak", "6,5", "CJA")],
                [reportPlayer("12", "Bočkaj", "6,5", "AI"), reportPlayer("44", "Barać", "6,9", "DC"), reportPlayer("16", "Tepšić", "6,6", "CC"), reportPlayer("23", "Maglica", "6,6", "DL")],
                [reportPlayer("34", "Novak", "6,4", "GR")]
            ]),
            away: reportFormation("3-4-2-1", [
                [reportPlayer("7", "Dabro", "6,3", "AAE")],
                [reportPlayer("28", "Šunta", "6,5", "CJA"), reportPlayer("26", "Wolski", "6,8", "MO")],
                [reportPlayer("3", "Jakir", "6,7", "AP"), reportPlayer("8", "Mrowca", "6,5", "Pi"), reportPlayer("21", "Crepulja", "6,8", "CJR", true), reportPlayer("18", "Krušelj", "6,6", "AP")],
                [reportPlayer("5", "Katalinić", "6,4", "CPO"), reportPlayer("6", "Božić", "6,6", "CP"), reportPlayer("4", "Kovačić", "7,0", "DC")],
                [reportPlayer("31", "Hadžikić", "6,5", "GR")]
            ])
        },
        events: {
            home: [goalEvent("45+1", "I. Tavares", { assist: "R. Brajković" })],
            away: [goalEvent("45", "L. Crepulja", { penalty: true })]
        },
        stats: reportStats([
            ["Posse", "47%", "53%"],
            ["Remates", "11", "8"],
            ...
            ["Cartões amarelos", "0", "0"],
            ["Cartões vermelhos", "0", "0"],
            ["Distância Percorrida", "120", "118"],
            ["Classificação Média", "6,7", "6,6"]
        ])
    },
    {
        fixtureKey: "2025-05-09-hnk-vukovar-dinamo-zagreb",
        date: "Sábado 9 de Maio de 2026",
        stadium: "Gradski vrt",
        weather: "Tempestuoso",
        playerOfMatch: "Luka Stojković",
        ...
        formations: {
            home: reportFormation("4-3-3 DM", [
                [reportPlayer("21", "Puljić", "6,6", "AAE")],
                [reportPlayer("8", "Horvat", "7,2", "AI", true), reportPlayer("36", "Butić", "6,2", "AI")],
                [reportPlayer("77", "Shabani", "6,8", "MC"), reportPlayer("43", "Čuić", "7,3", "CJA")],
                [reportPlayer("13", "Čaić", "6,5", "MD")],
                [reportPlayer("3", "Bosec", "6,7", "AI"), reportPlayer("5", "Elez", "6,7", "CC"), reportPlayer("4", "Mitrović", "7,0", "DC"), reportPlayer("91", "Tićinović", "6,5", "AI")],
                [reportPlayer("1", "Bulat", "6,6", "GR")]
            ]),
            away: reportFormation("4-3-3 DM", [
                [reportPlayer("9", "Dion Beljo", "6,7", "AvR")],
                [reportPlayer("11", "Hoxha", "7,1", "EAI"), reportPlayer("12", "Dobre", "7,0", "EAI")],
                [reportPlayer("14", "Soldo", "6,8", "MC"), reportPlayer("8", "Zajc", "6,6", "MC")],
                [reportPlayer("27", "Mišić", "6,4", "MD")],
                [reportPlayer("22", "Pérez Vinlöf", "7,0", "AI"), reportPlayer("26", "McKenna", "7,0", "CC"), reportPlayer("36", "Domínguez", "6,8", "CC"), reportPlayer("25", "Valinčić", "6,7", "AI")],
                [reportPlayer("40", "Livaković", "7,0", "GR")]
            ])
        },
        events: {
            home: [goalEvent("46", "P. Horvat", { assist: "M. Čuić" })],
            away: [goalEvent("50", "L. Stojković", { assist: "A. Dobre" })]
        },
        stats: reportStats([
            ["Posse", "61%", "39%"],
            ["Remates", "8", "19"],
    ...
    {
        fixtureKey: "2025-05-16-dinamo-zagreb-nk-lokomotiva",
        date: "Sábado 16 de Maio de 2026",
        stadium: "Maksimir",
        weather: "Calmo",
        playerOfMatch: "Moris Valinčić",
        rating: "8,04",
        coaches: { home: "M. Kovačević", away: "Pai Natal" },
        formations: {
            home: reportFormation("4-3-3 DM", [
                [reportPlayer("9", "Dion Beljo", "6,5", "AvR")],
                [reportPlayer("7", "Stojković", "7,3", "EAI", true), reportPlayer("12", "Dobre", "7,5", "EAI", true)],
                [reportPlayer("14", "Soldo", "6,6", "MC"), reportPlayer("8", "Zajc", "6,6", "MC")],
                [reportPlayer("27", "Mišić", "6,6", "MD")],
                [reportPlayer("22", "Pérez Vinlöf", "7,1", "AI"), reportPlayer("26", "McKenna", "6,8", "CC"), reportPlayer("36", "Domínguez", "7,0", "CC"), reportPlayer("25", "Valinčić", "8,0", "AI")],
                [reportPlayer("40", "Livaković", "7,1", "GR")]
            ]),
            away: reportFormation("4-3-3 DM", [
                [reportPlayer("9", "Sabra", "6,3", "AC")],
                [reportPlayer("80", "Redmond", "6,5", "AA"), reportPlayer("18", "Šitum", "6,2", "AA")],
                [reportPlayer("21", "Wintle", "6,9", "MC"), reportPlayer("8", "Antolić", "6,4", "ME")],
                [reportPlayer("28", "Belcar", "6,6", "CJR")],
                [reportPlayer("25", "Kamenović", "7,0", "DL"), reportPlayer("20", "Kolinger", "6,6", "DC"), reportPlayer("13", "Zebić", "6,5", "CC"), reportPlayer("23", "Vešović", "6,4", "DL")],
                [reportPlayer("12", "Posavec", "6,7", "GR")]
            ])
        },
        events: {
            home: [goalEvent("9", "A. Dobre"), goalEvent("27", "L. Stojković", { assist: "M. Valinčić" })],
            away: []
        },
        stats: reportStats([
            ["Posse", "43%", "57%"],
    ...
    {
        fixtureKey: "2025-05-16-nk-istra-1961-hnk-gorica",
        date: "Sábado 16 de Maio de 2026",
        stadium: "Aldo Drosina",
        weather: "Brisa",
        playerOfMatch: "Silvio Goričan",
        ...
        formations: {
            home: reportFormation("4-2-3-1", [
                [reportPlayer("9", "Prevljak", "7,4", "AC", true)],
                [reportPlayer("11", "Goričan", "9,2", "AA", true), reportPlayer("21", "Núñez", "6,9", "MO"), reportPlayer("7", "Benny", "7,1", "EAI")],
                [reportPlayer("8", "Maurić", "7,7", "MD", true), reportPlayer("15", "Liber", "7,5", "CJR")],
                [reportPlayer("26", "Heister", "8,3", "AI"), reportPlayer("4", "Johnston", "7,4", "CC"), reportPlayer("3", "Nasraoui", "7,3", "DC"), reportPlayer("2", "Ángel Pérez", "6,6", "AI")],
                [reportPlayer("99", "Wrąbel", "6,6", "GRC")]
            ]),
            away: reportFormation("4-3-3 DM", [
                [reportPlayer("20", "Vrzić", "6,0", "Ex"), reportPlayer("10", "Pršir", "6,8", "ME", true), reportPlayer("9", "Bogojević", "5,9", "Ex")],
                [reportPlayer("8", "Pozo", "6,5", "CJA"), reportPlayer("7", "Bakić", "6,5", "MC")],
                [reportPlayer("36", "Kavelj", "6,4", "MD")],
                [reportPlayer("32", "Duraković", "7,2", "AI"), reportPlayer("4", "Filipović", "6,3", "DC"), reportPlayer("5", "Leš", "6,6", "CP"), reportPlayer("22", "Trontelj", "6,7", "AI")],
                [reportPlayer("71", "Matijaš", "7,9", "GRC")]
            ])
        },
        events: {
            home: [goalEvent("12", "S. Prevljak", { assist: "M. Heister" }), goalEvent("45+2", "S. Goričan", { assist: "M. Heister" }), goalEvent("69", "A. Maurić", { assist: "C. Núñez" }), goalEvent("78", "S. Goričan", { assist: "G. Johnston" })],
            away: [goalEvent("4", "J. Pršir", { assist: "E. Duraković" })]
        },
        stats: reportStats([
            ["Posse", "69%", "31%"],
            ["Remates", "22", "11"],
            ...
            ["Cruzamentos Completados", "33%", "24%"],
            ["Faltas", "8", "11"],
            ["Cartões amarelos", "2", "1"],
            ["Cartões vermelhos", "0", "0"],
            ["Distância Percorrida", "117", "115"],
            ["Classificação Média", "7,4", "6,6"]
        ])
    },
    {
        fixtureKey: "2025-05-16-nk-osijek-nk-varazdin",
        date: "Sábado 16 de Maio de 2026",
        stadium: "Opus Arena",
        weather: "Calmo",
        playerOfMatch: "Luka Jelenić",
        rating: "8,28",
        coaches: { home: "Gamy Chambelito", away: "João Nabais" },
        formations: {
            home: reportFormation("3-1-3-2-1", [
                [reportPlayer("34", "Matković", "6,6", "AR")],
                [reportPlayer("23", "Vrbančić", "6,3", "MO"), reportPlayer("17", "Jakupović", "6,5", "SA")],
                [reportPlayer("38", "Čolina", "7,7", "MAI"), reportPlayer("6", "Álvarez", "6,9", "MC"), reportPlayer("39", "Bukvić", "6,3", "MAI")],
                [reportPlayer("32", "Kata", "6,6", "CJR")],
                [reportPlayer("2", "Racoviţan", "6,9", "CC"), reportPlayer("15", "Mersinaj", "6,9", "CP"), reportPlayer("26", "Jelenić", "8,3", "CC", true)],
                [reportPlayer("12", "Diogo Sousa", "7,4", "GR")]
            ]),
            away: reportFormation("4-2-3-1", [
                [reportPlayer("17", "Mamut", "6,4", "AR")],
                [reportPlayer("7", "Vuk", "7,1", "AI", true), reportPlayer("22", "Mamić", "6,2", "SA"), reportPlayer("18", "Gaprindashvili", "6,5", "Ex")],
                [reportPlayer("6", "Puclin", "7,1", "CJR"), reportPlayer("8", "Duvnjak", "6,4", "CJA")],
                [reportPlayer("15", "Jacob", "7,2", "AI"), reportPlayer("44", "Barać", "6,3", "DC"), reportPlayer("16", "Tepšić", "6,8", "CC"), reportPlayer("23", "Maglica", "6,6", "DL")],
                [reportPlayer("33", "Silić", "6,3", "GR")]
            ])
        },
        events: {
            home: [goalEvent("41", "L. Jelenić", { assist: "F. Álvarez" }), goalEvent("71", "L. Jelenić", { assist: "D. Čolina" }), goalEvent("84", "M. Cobnan", { assist: "D. Čolina" })],
            away: [goalEvent("12", "M. Vuk", { assist: "D. Puclin" })]
        },
        stats: reportStats([
            ["Posse", "51%", "49%"],
            ["Remates", "7", "13"],
    ...
    {
        fixtureKey: "2025-05-16-hnk-rijeka-hnk-vukovar",
        date: "Sábado 16 de Maio de 2026",
        stadium: "Rujevica",
        weather: "Calmo",
        playerOfMatch: "Merveil Ndockyt",
        ...
        formations: {
            home: reportFormation("4-2-1-2-1", [
                [reportPlayer("77", "Jurić", "8,6", "AAE", true)],
                [reportPlayer("69", "Schaub", "6,7", "ME"), reportPlayer("27", "Ambrose", "6,8", "MO")],
                [reportPlayer("26", "Tiago Dantas", "6,2", "MC")],
                [reportPlayer("15", "Martínez", "6,4", "MD"), reportPlayer("11", "André", "7,1", "CJR")],
                [reportPlayer("34", "Devetak", "6,9", "AI"), reportPlayer("29", "Barišić", "6,0", "CC"), reportPlayer("4", "Andrade", "6,9", "CC"), reportPlayer("23", "Lasickas", "6,9", "AI")],
                [reportPlayer("1", "Letica", "6,3", "GRC")]
            ]),
            away: reportFormation("4-3-3 DM", [
                [reportPlayer("33", "Mrkonjić", "6,9", "AAE", true)],
                [reportPlayer("10", "Gonzalez", "6,4", "AI"), reportPlayer("9", "Kulušić", "6,6", "AI")],
                [reportPlayer("41", "Šporn", "6,5", "MC"), reportPlayer("43", "Čuić", "6,6", "CJA")],
                [reportPlayer("18", "Akpata", "6,0", "MD")],
                [reportPlayer("3", "Bosec", "6,3", "AI"), reportPlayer("12", "Živković", "6,6", "CC"), reportPlayer("34", "Tadić", "6,7", "DC"), reportPlayer("25", "Williams", "6,3", "AI")],
                [reportPlayer("1", "Bulat", "8,4", "GR")]
            ])
        },
        events: {
            home: [goalEvent("48", "M. Ndockyt", { assist: "T. Fruk" }), goalEvent("86", "M. Ndockyt", { assist: "A. Jurić" }), goalEvent("90+2", "A. Jurić", { assist: "M. Ndockyt" })],
            away: [goalEvent("20", "T. Mrkonjić", { assist: "M. Bulat" }), goalEvent("40", "T. Barišić", { ownGoal: true })]
        },
        stats: reportStats([
            ["Posse", "58%", "42%"],
            ["Remates", "25", "4"],
            ["Remates à Baliza", "16", "3"],
            ["xG", "4,41", "0,43"],
            ["PADPAD", "15,48", "24,38"],
            ["Oportunidades Flagrantes", "4", "0"],
            ["Cantos", "12", "1"],
            ["Passes Completados", "91%", "84%"],
            ["Cruzamentos Completados", "35%", "20%"],
            ["Faltas", "22", "11"],
            ["Cartões amarelos", "1", "2"],
            ["Cartões vermelhos", "0", "0"],
            ["Distância Percorrida", "121", "114"],
            ["Classificação Média", "7,1", "6,6"]
        ])
    },
    {
        fixtureKey: "2025-05-16-nk-slaven-belupo-hajduk-split",
        date: "Sábado 16 de Maio de 2026",
        stadium: "Gradski stadion Ivan Kušek Apaš",
        weather: "Brisa",
        playerOfMatch: "Toni Silić",
        rating: "7,89",
        coaches: { home: "Francisco Pinto", away: "S. Bilić" },
        formations: {
            home: reportFormation("3-4-2-1", [
                [reportPlayer("7", "Dabro", "6,2", "AAE")],
                [reportPlayer("28", "Šunta", "6,7", "CJA"), reportPlayer("26", "Wolski", "6,5", "MO")],
                [reportPlayer("3", "Jakir", "6,2", "AP"), reportPlayer("8", "Mrowca", "6,4", "Pi"), reportPlayer("21", "Crepulja", "6,8", "CJR"), reportPlayer("18", "Krušelj", "6,9", "AP")],
                [reportPlayer("5", "Katalinić", "6,7", "CPO"), reportPlayer("6", "Božić", "7,0", "CP"), reportPlayer("4", "Kovačić", "7,5", "DC")],
                [reportPlayer("31", "Hadžikić", "7,5", "GR")]
            ]),
            away: reportFormation("4-2-3-1", [
                [reportPlayer("34", "Durdov", "6,3", "AAE")],
                [reportPlayer("11", "Šego", "6,3", "AI"), reportPlayer("21", "Pukstas", "6,7", "SA"), reportPlayer("30", "Almena", "6,2", "AI")],
                [reportPlayer("23", "Krovinović", "6,7", "CJR"), reportPlayer("6", "Guillamón", "7,1", "MD")],
                [reportPlayer("32", "Hrgović", "6,8", "AI"), reportPlayer("31", "Šarlija", "7,0", "CP"), reportPlayer("58", "Skelin", "7,0", "CC"), reportPlayer("38", "Hodak", "7,0", "DL")],
                [reportPlayer("33", "Silić", "7,9", "GR")]
            ])
        },
        events: {
            home: [],
    ...
    {
        fixtureKey: "2025-05-23-dinamo-zagreb-hnk-rijeka",
        date: "Sábado 23 de Maio de 2026",
        stadium: "Maksimir",
        weather: "Calmo",
        playerOfMatch: "Merveil Ndockyt",
        rating: "9,75",
        ...
        formations: {
            home: reportFormation("4-3-3 DM", [
                [reportPlayer("9", "Dion Beljo", "6,4", "AvR")],
                [reportPlayer("11", "Hoxha", "7,2", "EAI", true), reportPlayer("12", "Dobre", "6,7", "EAI")],
                [reportPlayer("14", "Soldo", "6,6", "ME"), reportPlayer("7", "Stojković", "6,3", "MC")],
                [reportPlayer("8", "Zajc", "6,6", "CJR")],
                [reportPlayer("22", "Pérez Vinlöf", "7,0", "DL"), reportPlayer("26", "McKenna", "6,8", "CC"), reportPlayer("36", "Domínguez", "6,8", "CC"), reportPlayer("25", "Valinčić", "6,2", "AI")],
                [reportPlayer("40", "Livaković", "7,1", "GR")]
            ]),
            away: reportFormation("4-2-1-2-1", [
                [reportPlayer("7", "Baldé", "6,9", "AAE")],
                [reportPlayer("20", "Ndockyt", "9,8", "ME", true), reportPlayer("10", "Fruk", "9,5", "MO", true)],
                [reportPlayer("14", "Gojak", "6,7", "MC")],
                [reportPlayer("21", "Lacoux", "7,0", "MD"), reportPlayer("17", "Ntcham", "7,0", "CJR")],
                [reportPlayer("24", "Silva", "7,9", "AI"), reportPlayer("53", "Emirhan", "6,4", "CC"), reportPlayer("6", "Radeljić", "6,7", "CC"), reportPlayer("22", "Oreč", "7,1", "AI")],
                [reportPlayer("1", "Letica", "7,1", "GRC")]
            ])
        },
        events: {
            home: [goalEvent("1", "A. Hoxha", { assist: "M. Pérez Vinlöf" }), goalEvent("34", "Emirhan Topçu", { ownGoal: true })],
            away: [goalEvent("4", "T. Fruk", { assist: "M. Ndockyt" }), goalEvent("40", "T. Fruk", { assist: "M. Ndockyt" }), goalEvent("47", "M. Ndockyt", { assist: "J. Silva" }), goalEvent("82", "A. Jurić", { assist: "T. Fruk" })]
        },
        stats: reportStats([
            ["Posse", "40%", "60%"],
            ["Remates", "11", "18"],
            ["Remates à Baliza", "7", "12"],
            ["xG", "0,92", "2,28"],
            ["PADPAD", "19,79", "15,58"],
            ["Oportunidades Flagrantes", "0", "3"],
            ["Cantos", "6", "9"],
            ...
            ["Cartões amarelos", "1", "2"],
            ["Cartões vermelhos", "0", "0"],
            ["Distância Percorrida", "136", "141"],
            ["Classificação Média", "6,7", "7,5"]
        ])
    },
    {
        fixtureKey: "2025-05-23-hajduk-split-nk-osijek",
        date: "Sábado 23 de Maio de 2026",
        stadium: "Poljud",
        weather: "Calmo",
        playerOfMatch: "Luka Jelenić",
        rating: "7,62",
        coaches: { home: "S. Bilić", away: "Gamy Chambelito" },
        formations: {
            home: reportFormation("4-2-3-1", [
                [reportPlayer("11", "Šego", "6,7", "AAE")],
                [reportPlayer("9", "Rebić", "6,7", "CJA"), reportPlayer("10", "Livaja", "6,7", "MO"), reportPlayer("30", "Almena", "6,6", "AI")],
                [reportPlayer("23", "Krovinović", "6,8", "CJR"), reportPlayer("6", "Guillamón", "6,7", "MD")],
                [reportPlayer("32", "Hrgović", "6,9", "AI"), reportPlayer("14", "Raçi", "7,3", "CC"), reportPlayer("15", "Marešić", "6,8", "CC"), reportPlayer("38", "Hodak", "7,3", "DL")],
                [reportPlayer("33", "Silić", "7,1", "GR")]
            ]),
            away: reportFormation("3-1-3-2-1", [
                [reportPlayer("17", "Jakupović", "6,7", "AR")],
                [reportPlayer("3", "Barišić", "6,7", "MO"), reportPlayer("39", "Bukvić", "6,7", "SA")],
                [reportPlayer("34", "Matković", "6,6", "MAI"), reportPlayer("23", "Vrbančić", "6,4", "MC"), reportPlayer("27", "Mikić", "7,1", "MAI")],
                [reportPlayer("6", "Álvarez", "6,8", "CJR")],
                [reportPlayer("2", "Racoviţan", "7,5", "CC"), reportPlayer("32", "Kata", "6,8", "CP"), reportPlayer("26", "Jelenić", "7,6", "CC")],
                [reportPlayer("12", "Diogo Sousa", "7,1", "GR")]
            ])
        },
        events: {
            home: [],
        ...
        stats: reportStats([
            ...
            ["Cartões amarelos", "1", "0"],
            ["Cartões vermelhos", "0", "0"],
            ["Distância Percorrida", "131", "125"],
            ["Classificação Média", "6,9", "6,9"]
        ])
    },
    {
        fixtureKey: "2025-05-23-hnk-gorica-nk-slaven-belupo",
        date: "Sábado 23 de Maio de 2026",
        stadium: "Gradski stadion Velika Gorica",
        weather: "Calmo",
        playerOfMatch: "Marko Dabro",
        ...
        formations: {
            home: reportFormation("4-3-3 DM", [
                [reportPlayer("31", "Echue", "6,5", "Ex"), reportPlayer("64", "Epailly", "7,6", "ME"), reportPlayer("36", "Kavelj", "6,2", "Ex")],
                [reportPlayer("18", "Fiolić", "6,5", "CJA"), reportPlayer("66", "Frigan", "6,8", "MC", true)],
                [reportPlayer("20", "Vrzić", "6,1", "MD")],
                [reportPlayer("19", "Čabraja", "7,1", "AI"), reportPlayer("5", "Leš", "6,3", "DC"), reportPlayer("35", "Josić", "6,3", "CP"), reportPlayer("45", "Perić", "6,6", "AI")],
                [reportPlayer("71", "Matijaš", "6,4", "GRC")]
            ]),
            away: reportFormation("3-4-2-1", [
                [reportPlayer("7", "Dabro", "10,0", "AAE", true)],
                [reportPlayer("28", "Šunta", "6,3", "CJA"), reportPlayer("26", "Wolski", "7,0", "MO")],
                [reportPlayer("3", "Jakir", "8,3", "AP", true), reportPlayer("8", "Mrowca", "6,4", "Pi"), reportPlayer("21", "Crepulja", "6,7", "CJR"), reportPlayer("18", "Krušelj", "7,7", "AP", true)],
                [reportPlayer("5", "Katalinić", "6,7", "CPO"), reportPlayer("6", "Božić", "7,1", "CP"), reportPlayer("4", "Kovačić", "6,8", "DC")],
                [reportPlayer("31", "Hadžikić", "6,7", "GR")]
            ])
        },
        events: {
            home: [goalEvent("30", "J. Frigan", { assist: "M. Čabraja" }), goalEvent("82", "W. Sule", { assist: "T. Epailly" })],
            away: [goalEvent("32", "A. Jakir", { assist: "M. Dabro" }), goalEvent("65", "M. Dabro"), goalEvent("66", "F. Krušelj", { assist: "M. Dabro" }), goalEvent("75", "M. Dabro"), goalEvent("85", "I. Ćubelić", { assist: "M. Dabro" })]
        },
        stats: reportStats([
            ["Posse", "47%", "53%"],
            ["Remates", "13", "16"],
            ["Remates à Baliza", "6", "12"],
            ["xG", "1,57", "2,39"],
            ["PADPAD", "23,94", "22,67"],
            ["Oportunidades Flagrantes", "2", "2"],
            ["Cantos", "7", "12"],
            ["Passes Completados", "89%", "90%"],
            ["Cruzamentos Completados", "15%", "23%"],
            ["Faltas", "8", "9"],
            ["Cartões amarelos", "0", "1"],
            ["Cartões vermelhos", "0", "0"],
            ["Distância Percorrida", "125", "127"],
    ...
    {
        fixtureKey: "2025-05-23-nk-varazdin-nk-lokomotiva",
        date: "Sábado 23 de Maio de 2026",
        stadium: "Anđelko Herjavec",
        weather: "Calmo",
        playerOfMatch: "Matej Vuk",
        ...
        formations: {
            home: reportFormation("4-2-3-1", [
                [reportPlayer("17", "Mamut", "7,7", "AR", true)],
                [reportPlayer("7", "Vuk", "10,0", "AI", true), reportPlayer("27", "Latković", "7,8", "SA"), reportPlayer("11", "Brajković", "6,6", "Ex")],
                [reportPlayer("16", "Tepšić", "7,2", "CJR"), reportPlayer("14", "Ilinković", "7,5", "CJA", true)],
                [reportPlayer("15", "Jacob", "7,4", "AI"), reportPlayer("44", "Barać", "7,4", "DC"), reportPlayer("13", "Mladenovski", "6,7", "CC"), reportPlayer("23", "Maglica", "7,4", "DL")],
                [reportPlayer("33", "Silić", "6,9", "GR")]
            ]),
            away: reportFormation("4-3-3 DM", [
                [reportPlayer("40", "McCarthy", "6,5", "AA"), reportPlayer("10", "Rui Pedro", "6,9", "AC", true), reportPlayer("20", "Kolinger", "6,8", "AA")],
                [reportPlayer("28", "Belcar", "6,4", "MC"), reportPlayer("80", "Redmond", "6,1", "ME")],
                [reportPlayer("15", "Stojaković", "6,6", "CJR")],
                [reportPlayer("17", "Pajač", "6,6", "DL"), reportPlayer("3", "Diop", "6,7", "DC"), reportPlayer("18", "Šitum", "6,2", "CC"), reportPlayer("19", "Tabinas", "6,7", "DL")],
                [reportPlayer("99", "Vózinha", "6,2", "GR")]
            ])
        },
        events: {
            home: [goalEvent("24", "I. Mamut", { assist: "M. Vuk" }), goalEvent("38", "M. Vuk", { assist: "I. Mamut" }), goalEvent("68", "S. Ilinković", { assist: "M. Jacob" }), goalEvent("77", "M. Vuk", { assist: "A. Latković" })],
            away: [goalEvent("71", "Rui Pedro", { assist: "M. Rog" })]
        },
        stats: reportStats([
            ["Posse", "50%", "50%"],
            ["Remates", "28", "7"],
            ...
            ["Cantos", "17", "4"],
            ["Passes Completados", "87%", "85%"],
            ["Cruzamentos Completados", "26%", "10%"],
            ["Faltas", "12", "3"],
            ["Cartões amarelos", "1", "0"],
            ["Cartões vermelhos", "0", "0"],
            ["Distância Percorrida", "127", "122"],
            ["Classificação Média", "7,5", "6,6"]
        ])
    },
    {
        fixtureKey: "2025-05-23-hnk-vukovar-nk-istra-1961",
        date: "Sábado 23 de Maio de 2026",
        stadium: "Gradski vrt",
        weather: "Calmo",
        playerOfMatch: "Emil Frederiksen",
        ...
        formations: {
            home: reportFormation("4-3-3 DM", [
                [reportPlayer("36", "Butić", "6,1", "AI"), reportPlayer("30", "Vinković", "6,4", "AAE"), reportPlayer("13", "Čaić", "6,9", "AI")],
                [reportPlayer("41", "Šporn", "6,7", "MC"), reportPlayer("9", "Kulušić", "7,2", "CJA", true)],
                [reportPlayer("43", "Čuić", "6,8", "MD", true)],
                [reportPlayer("7", "Kerim Çalh.", "6,2", "AI"), reportPlayer("15", "Gurlica", "6,3", "CC"), reportPlayer("12", "Živković", "6,4", "DC"), reportPlayer("25", "Williams", "6,2", "AI")],
                [reportPlayer("1", "Bulat", "7,7", "GR")]
            ]),
            away: reportFormation("4-2-3-1", [
                [reportPlayer("9", "Prevljak", "6,3", "AC")],
                [reportPlayer("7", "Benny", "6,5", "AA"), reportPlayer("21", "Núñez", "7,9", "MO", true), reportPlayer("17", "Frederiksen", "8,7", "EAI", true)],
                [reportPlayer("8", "Maurić", "6,8", "MD"), reportPlayer("15", "Liber", "7,9", "CJR", true)],
                [reportPlayer("26", "Heister", "7,1", "AI"), reportPlayer("4", "Johnston", "7,0", "CC"), reportPlayer("3", "Nasraoui", "7,0", "DC"), reportPlayer("2", "Ángel Pérez", "6,6", "AI")],
                [reportPlayer("99", "Wrąbel", "6,4", "GRC")]
            ])
        },
        events: {
            home: [goalEvent("79", "M. Čuić", { assist: "L. Kulušić" }), goalEvent("90", "L. Kulušić", { assist: "T. Akpata" })],
            away: [goalEvent("16", "C. Núñez", { penalty: true }), goalEvent("71", "A. Liber", { assist: "E. Frederiksen" }), goalEvent("76", "E. Frederiksen", { assist: "A. Obando" }), goalEvent("88", "S. Goričan", { assist: "C. Núñez" })]
        },
        stats: reportStats([
            ["Posse", "38%", "62%"],
            ["Remates", "8", "21"],
            ...
            ["Oportunidades Flagrantes", "0", "2"],
            ["Cantos", "4", "7"],
            ["Passes Completados", "89%", "93%"],
            ["Cruzamentos Completados", "18%", "30%"],
            ["Faltas", "5", "12"],
            ["Cartões amarelos", "0", "1"],
            ["Cartões vermelhos", "0", "0"],
            ["Distância Percorrida", "121", "126"],
            ["Classificação Média", "6,6", "7,2"]
        ])
    }
];
