...
const croatiaMatchReports = [
    ...
    },
    {
        ...
        formations: {
            home: reportFormation("3-4-2-1", [
                ...
                [reportPlayer("3", "Bosec", "7,2", "AI"), reportPlayer("13", "Ćaić", "6,5", "MD"), reportPlayer("10", "Gonzalez", "7,4", "CJR"), reportPlayer("91", "Tićinović", "9,8", "AI", true)],
    ...
    },
    {
        ...
        formations: {
            ...
            away: reportFormation("3-4-2-1", [
                ...
                [reportPlayer("3", "Bosec", "7,0", "AI"), reportPlayer("13", "Ćaić", "6,4", "MD"), reportPlayer("10", "Gonzalez", "6,0", "CJR"), reportPlayer("91", "Tićinović", "6,5", "AI")],
    ...
    },
    {
        ...
        formations: {
            home: reportFormation("3-4-2-1", [
                ...
                [reportPlayer("35", "Kauã Valente", "6,3", "AI"), reportPlayer("13", "Ćaić", "6,7", "MD"), reportPlayer("10", "Gonzalez", "6,9", "CJR", true), reportPlayer("91", "Tićinović", "7,3", "AI")],
    ...
    },
    {
        ...
        formations: {
            ...
            away: reportFormation("4-2-3-1", [
                ...
                [reportPlayer("13", "Ćaić", "7,2", "MC"), reportPlayer("77", "Shabani", "7,6", "MO", true)],
    ...
    },
    {
        ...
        formations: {
            ...
            away: reportFormation("4-3-3 DM", [
                [reportPlayer("64", "Epailly", "6,0", "Ex"), reportPlayer("10", "Pršir", "6,1", "ME"), reportPlayer("9", "Bogoević", "6,3", "Ex")],
    ...
    },
    {
        ...
        formations: {
            home: reportFormation("4-2-3-1 DM AM", [
                ...
                [reportPlayer("11", "Goričan", "6,4", "AA"), reportPlayer("14", "Tóth", "6,8", "MO"), reportPlayer("17", "Frederiksen", "6,4", "EAI")],
                [reportPlayer("10", "Lončar", "6,5", "MD"), reportPlayer("5", "Radošević", "6,3", "CJR")],
                [reportPlayer("26", "Heister", "6,7", "AI"), reportPlayer("8", "Mauric", "6,7", "CC"), reportPlayer("3", "Nasraoui", "6,6", "DC"), reportPlayer("97", "Kadušić", "6,3", "AI")],
                [reportPlayer("1", "Kolić", "6,4", "GRC")]
            ]),
            away: reportFormation("4-3-3 DM", [
    ...
    },
    {
        ...
        formations: {
            home: reportFormation("4-2-3-1 DM AM", [
                [reportPlayer("7", "Keita Baldé", "8,0", "AR", true)],
                [reportPlayer("14", "Gojak", "7,8", "ME"), reportPlayer("10", "Fruk", "7,6", "MO", true)],
            ...
            away: reportFormation("4-3-3 DM", [
                ...
                [reportPlayer("21", "Pukštas", "6,5", "MC"), reportPlayer("23", "Krovinović", "6,4", "MO")],
                [reportPlayer("7", "Kalik", "7,2", "MD")],
                [reportPlayer("32", "Hrgović", "6,4", "AI"), reportPlayer("14", "Raci", "6,6", "CC"), reportPlayer("15", "Marešić", "5,8", "CC"), reportPlayer("38", "Hodak", "6,4", "DL")],
    ...
    },
    {
        ...
        formations: {
            home: reportFormation("4-2-4", [
                ...
                [reportPlayer("35", "Žuta", "6,0", "AI"), reportPlayer("5", "Katalinić", "6,4", "DC"), reportPlayer("4", "Ković", "6,6", "CC"), reportPlayer("18", "Krušelj", "6,3", "DL")],
                [reportPlayer("31", "Hadžikić", "6,6", "GR")]
            ]),
            away: reportFormation("5-2-2-1 DM", [
                ...
                [reportPlayer("23", "Vrbanić", "7,7", "MC"), reportPlayer("21", "Bubanja", "7,4", "Pi")],
                [reportPlayer("20", "Gradel", "7,6", "MAI"), reportPlayer("26", "Jelenić", "7,0", "CP"), reportPlayer("34", "Matković", "9,8", "CP", true), reportPlayer("33", "Hasić", "7,1", "CP"), reportPlayer("29", "Karačić", "6,4", "MAI")],
    ...
    },
    {
        ...
        formations: {
            home: reportFormation("3-4-2-1 DM", [
                [reportPlayer("10", "Gonzalez", "6,4", "AAE")],
                [reportPlayer("15", "Gurlica", "6,6", "MO"), reportPlayer("", "Jurić", "6,3", "MO")],
                [reportPlayer("9", "Kulušić", "6,5", "AI"), reportPlayer("20", "Čabrajić", "6,4", "MD"), reportPlayer("8", "Horvat", "8,0", "CJR", true), reportPlayer("3", "Bosec", "6,4", "AI")],
                [reportPlayer("5", "Elez", "7,0", "CC"), reportPlayer("4", "Mitrović", "7,0", "CC"), reportPlayer("91", "Tićinović", "7,0", "CC")],
                [reportPlayer("42", "Đaković", "6,6", "GR")]
            ]),
            away: reportFormation("3-4-1-2 DM", [
                [reportPlayer("7", "Trajkovski", "7,0", "AAE"), reportPlayer("28", "Belcar", "6,7", "AvR")],
                [reportPlayer("26", "Rog", "6,7", "MC"), reportPlayer("8", "Antolić", "6,4", "CJA"), reportPlayer("16", "Dajčer", "6,7", "MC")],
                [reportPlayer("22", "Leovac", "6,7", "AI"), reportPlayer("23", "Vesović", "6,3", "AI")],
                [reportPlayer("4", "Sigali", "7,3", "DC"), reportPlayer("10", "Rui Pedro", "7,1", "CP", true), reportPlayer("20", "Kolinger", "6,6", "CP")],
    ...
    },
    {
        ...
        formations: {
            home: reportFormation("3-4-1-2", [
                [reportPlayer("7", "Trajkovski", "6,9", "AAE", true), reportPlayer("28", "Belcar", "6,6", "AvR")],
                [reportPlayer("26", "Rog", "6,8", "MC"), reportPlayer("8", "Antolić", "7,3", "CJA"), reportPlayer("16", "Jukić", "6,7", "MC")],
                [reportPlayer("17", "Pajač", "6,2", "AI"), reportPlayer("23", "Vesović", "6,3", "AI")],
                [reportPlayer("4", "Sigali", "6,5", "DC"), reportPlayer("10", "Rui Pedro", "6,7", "CP"), reportPlayer("20", "Kolinger", "6,6", "CP")],
        ...
        events: {
            ...
            away: [goalEvent("23", "Dion Beljo", { assist: "A. Hoxha" }), goalEvent("45", "Dion Beljo", { assist: "L. Stojković" }), goalEvent("55", "A. Hoxha"), sendOffEvent("88", "I. Bennacer"), goalEvent("90+2", "Dion Beljo", { assist: "P. Tabinas" })]
        },
        stats: reportStats([
            ["Posse", "56%", "44%"],
            ["Remates", "15", "10"],
    ...
    },
    {
        ...
        rating: "7,53",
        coaches: { home: "Gonzalo García", away: "João Pedro Rato" },
        formations: {
            home: reportFormation("4-3-3 DM", [
                [reportPlayer("13", "Elis", "6,3", "AR")],
                [reportPlayer("11", "Šego", "6,5", "EAI"), reportPlayer("30", "Almena", "7,0", "EAI")],
                [reportPlayer("7", "Kalik", "6,6", "MC"), reportPlayer("21", "Pukštas", "7,4", "MC", true)],
                [reportPlayer("6", "Hugo G.", "7,0", "MD")],
                [reportPlayer("3", "Auer", "6,9", "AI"), reportPlayer("14", "Raci", "6,4", "CC"), reportPlayer("31", "Šarlija", "6,6", "CP"), reportPlayer("38", "Hodak", "6,8", "AI")],
                [reportPlayer("33", "Silić", "6,4", "GR")]
            ]),
            away: reportFormation("4-2-3-1 DM AM", [
                [reportPlayer("14", "Tóth", "7,1", "AC", true)],
                [reportPlayer("11", "Goričan", "7,2", "AA", true), reportPlayer("9", "Prevljak", "7,2", "MO"), reportPlayer("17", "Frederiksen", "7,5", "EAI")],
                [reportPlayer("10", "Lončar", "6,4", "MD"), reportPlayer("23", "Štulac", "6,2", "CJR")],
                [reportPlayer("26", "Heister", "6,6", "AI"), reportPlayer("4", "Johnston", "6,6", "CC"), reportPlayer("3", "Nasraoui", "6,7", "DC"), reportPlayer("", "Hvatin", "6,7", "AI")],
                [reportPlayer("1", "Kolić", "6,5", "GRC")]
            ])
        },
        events: {
            home: [goalEvent("26", "R. Pukštas", { assist: "I. Almena" })],
    ...
    },
    {
        ...
        formations: {
            home: reportFormation("4-3-3 DM", [
                [reportPlayer("50", "Erceg", "6,0", "Ex"), reportPlayer("10", "Pršir", "6,3", "ME"), reportPlayer("9", "Bogoević", "6,2", "Ex")],
            ...
            away: reportFormation("4-2-3-1 DM AM", [
                [reportPlayer("7", "Keita Baldé", "7,7", "AR", true)],
                [reportPlayer("14", "Gojak", "6,5", "ME"), reportPlayer("10", "Fruk", "8,2", "MO")],
                [reportPlayer("8", "Petrovič", "6,9", "MC")],
                [reportPlayer("15", "Martínez T.", "7,4", "MD"), reportPlayer("26", "Dantas", "6,8", "CJR")],
                [reportPlayer("34", "Devetak", "7,9", "AI"), reportPlayer("53", "Emirhan", "7,0", "CC"), reportPlayer("6", "Radeljić", "7,3", "CC"), reportPlayer("22", "Oreč", "8,9", "AI", true)],
                [reportPlayer("1", "Letica", "7,7", "GR")]
            ])
        },
        events: {
            home: [],
            away: [goalEvent("66", "A. Oreč", { assist: "T. Fruk" }), goalEvent("85", "K. Baldé", { assist: "T. Ambrose" })]
        },
        stats: reportStats([
            ["Posse", "35%", "65%"],
            ["Remates", "7", "17"],
    ...
    },
    {
        ...
        formations: {
            home: reportFormation("3-4-1-2", [
                [reportPlayer("15", "Stojaković", "6,6", "AAE"), reportPlayer("", "Bošković", "6,4", "AvR")],
                [reportPlayer("28", "Belcar", "7,2", "MC", true), reportPlayer("8", "Antolić", "7,3", "CJA"), reportPlayer("5", "Diop", "6,5", "MC")],
                [reportPlayer("17", "Pajač", "6,7", "AI"), reportPlayer("23", "Vesović", "6,7", "AI")],
                [reportPlayer("4", "Sigali", "6,3", "DC"), reportPlayer("10", "Rui Pedro", "6,4", "CP"), reportPlayer("20", "Kolinger", "6,5", "CP")],
    ...
    },
    {
        ...
        formations: {
            home: reportFormation("4-2-3-1 DM AM", [
                ...
                [reportPlayer("3", "Sikošek", "6,6", "AI"), reportPlayer("44", "Barać", "6,6", "DC"), reportPlayer("16", "Tepšić", "6,9", "CC"), reportPlayer("23", "Škaričić", "7,2", "DL")],
                [reportPlayer("1", "Zelenika", "6,4", "GR")]
            ]),
            away: reportFormation("4-2-2-2 DM", [
                ...
                [reportPlayer("35", "Žuta", "6,9", "AI"), reportPlayer("6", "Božić", "6,9", "DC"), reportPlayer("4", "Ković", "6,9", "CC"), reportPlayer("18", "Krušelj", "6,9", "DL")],
    ...
    },
    {
        ...
        formations: {
            home: reportFormation("3-4-2-1 DM", [
                ...
                [reportPlayer("9", "Kulušić", "6,5", "AI"), reportPlayer("13", "Ćaić", "6,7", "MD"), reportPlayer("8", "Horvat", "6,1", "CJR"), reportPlayer("3", "Bosec", "6,1", "AI")],
            ...
            away: reportFormation("4-3-3 DM", [
                ...
                [reportPlayer("", "Tabinas", "6,6", "DL"), reportPlayer("15", "Galešić", "7,2", "CC"), reportPlayer("36", "Domínguez", "7,2", "CC"), reportPlayer("25", "Valinčić", "7,3", "AI")],
                [reportPlayer("40", "Livaković", "7,6", "GR")]
            ])
        },
        events: {
    ...
    },
    {
        ...
        formations: {
            ...
            away: reportFormation("3-4-1-2", [
                ...
                [reportPlayer("17", "Pajač", "6,6", "AI"), reportPlayer("23", "Vesović", "6,4", "AI")],
    ...
    },
    {
        ...
        formations: {
            ...
            away: reportFormation("4-3-3 DM", [
                [reportPlayer("50", "Erceg", "6,4", "Ex"), reportPlayer("10", "Pršir", "7,6", "ME", true), reportPlayer("9", "Bogoević", "6,4", "Ex")],
    ...
    },
    {
        ...
        formations: {
            ...
            away: reportFormation("3-4-2-1 DM", [
                [reportPlayer("9", "Kulušić", "7,0", "AAE", true)],
                [reportPlayer("8", "Horvat", "6,2", "MO"), reportPlayer("77", "Shabani", "6,3", "MO")],
                [reportPlayer("3", "Bosec", "6,3", "AI"), reportPlayer("15", "Gurlica", "6,8", "MD"), reportPlayer("13", "Ćaić", "6,6", "CJR"), reportPlayer("91", "Tićinović", "7,0", "AI")],
    ...
    },
    {
        ...
        formations: {
            home: reportFormation("4-2-2-2 DM", [
                ...
                [reportPlayer("35", "Žuta", "6,5", "AI"), reportPlayer("6", "Božić", "7,0", "DC"), reportPlayer("4", "Kovicić", "7,0", "CC"), reportPlayer("18", "Krušelj", "7,2", "DL")],
                [reportPlayer("31", "Hadžikić", "7,1", "GR")]
            ]),
            away: reportFormation("4-3-3 DM", [
                [reportPlayer("10", "Livaja", "6,4", "AR")],
                [reportPlayer("9", "A. Rebić", "6,5", "EAI"), reportPlayer("11", "Šego", "6,3", "EAI")],
                [reportPlayer("21", "Pukštas", "7,0", "MC"), reportPlayer("23", "Krovinović", "7,0", "MC")],
                [reportPlayer("6", "Hugo G.", "7,0", "MD")],
                [reportPlayer("3", "Auer", "6,4", "AI"), reportPlayer("14", "Raci", "6,5", "CC"), reportPlayer("15", "Marešić", "7,5", "CC"), reportPlayer("32", "Hrgović", "7,0", "AI")],
